...
/**
 * This is the item provider adapter for a {@link fieldofactivityannotations.HMIConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldofactivityannotationsPackage.Literals.HMI_CONFIGURATION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldofactivityannotationsPackage.Literals.HMI_CONFIGURATION__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldofactivityannotationsPackage.Literals.HMI_CONFIGURATION__MODULES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldofactivityannotationsPackage.Literals.HMI_CONFIGURATION__INTERFACES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldofactivityannotationsPackage.Literals.HMI_CONFIGURATION__STRUCTURES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HMIConfiguration_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HMIConfiguration_parent_feature", "_UI_HMIConfiguration_type"),
				 FieldofactivityannotationsPackage.Literals.HMI_CONFIGURATION__PARENT,
				 true,
				 false,
				 true,
				 null,
