 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.ComponentRepository.impl.TurningTableImpl#getRack_for_turningtable <em>Rack for turningtable</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.TurningTableImpl#getTable_to_stand_on <em>Table to stand on</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.TurningTableImpl#getMotor_to_drive <em>Motor to drive</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.TurningTableImpl#getMicroswitchModule <em>Microswitch Module</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.TurningTableImpl#getBusSlave <em>Bus Slave</em>}</li>
