...
public class ComponentRepositoryFactoryImpl extends EFactoryImpl implements ComponentRepositoryFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ComponentRepositoryPackage.RUBBER_BAND: return createRubberBand();
			...
			case ComponentRepositoryPackage.ARM: return createArm();
			case ComponentRepositoryPackage.TABLE: return createTable();
			case ComponentRepositoryPackage.GRIPPER_PART: return createGripperPart();
