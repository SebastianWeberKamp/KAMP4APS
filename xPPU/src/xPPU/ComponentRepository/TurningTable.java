 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.ComponentRepository.TurningTable#getRack_for_turningtable <em>Rack for turningtable</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.TurningTable#getTable_to_stand_on <em>Table to stand on</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.TurningTable#getMotor_to_drive <em>Motor to drive</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.TurningTable#getMicroswitchModule <em>Microswitch Module</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.TurningTable#getBusSlave <em>Bus Slave</em>}</li>
...
public interface TurningTable extends Component {
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getTurningTable_Rack_for_turningtable()
	...
	/**
	 * Sets the value of the '{@link xPPU.ComponentRepository.TurningTable#getRack_for_turningtable <em>Rack for turningtable</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getTurningTable_Table_to_stand_on()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link xPPU.ComponentRepository.TurningTable#getTable_to_stand_on <em>Table to stand on</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getTurningTable_Motor_to_drive()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link xPPU.ComponentRepository.TurningTable#getMotor_to_drive <em>Motor to drive</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link xPPU.ComponentRepository.MicroswitchModule}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getTurningTable_MicroswitchModule()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getTurningTable_BusSlave()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link xPPU.ComponentRepository.TurningTable#getBusSlave <em>Bus Slave</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getTurningTable_BusBox()
	 * @model containment="true" required="true"
	 * @generated
	 */
	BusBox getBusBox();
	...
	/**
	 * Sets the value of the '{@link xPPU.ComponentRepository.TurningTable#getBusBox <em>Bus Box</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getTurningTable_BusCable()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link xPPU.ComponentRepository.Potentiometer}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Potentiometer</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Potentiometer</em>' containment reference list.
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getTurningTable_Potentiometer()
	 * @model containment="true" required="true"
	 * @generated
	 */
