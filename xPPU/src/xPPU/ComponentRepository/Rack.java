 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.ComponentRepository.Rack#getScrewing_to_base <em>Screwing to base</em>}</li>
 * </ul>
 *
 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getRack()
 * @model
 * @generated
 */
public interface Rack extends Component {
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getRack_Screwing_to_base()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link xPPU.ComponentRepository.Rack#getScrewing_to_base <em>Screwing to base</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
