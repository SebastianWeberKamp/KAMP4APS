...
public class ComponentRepositorySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ComponentRepositoryPackage.RUBBER_BAND: {
			...
			case ComponentRepositoryPackage.ARM: {
			...
			case ComponentRepositoryPackage.RAMP: {
			...
			case ComponentRepositoryPackage.TABLE: {
			...
			case ComponentRepositoryPackage.GRIPPER_PART: {
	 ...
	 * @generated
	 */
	public T caseSwitch(xPPU.ElectronicComponents.Switch object) {
		return null;
	}
