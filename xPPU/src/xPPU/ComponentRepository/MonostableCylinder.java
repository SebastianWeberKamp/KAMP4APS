 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.ComponentRepository.MonostableCylinder#getHousing <em>Housing</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.MonostableCylinder#getSpring <em>Spring</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.MonostableCylinder#getReedSwitches <em>Reed Switches</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.MonostableCylinder#getCylinderPart <em>Cylinder Part</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.MonostableCylinder#getValve <em>Valve</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.MonostableCylinder#getBusSlave <em>Bus Slave</em>}</li>
 * </ul>
 *
 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getMonostableCylinder()
 * @model
 * @generated
 */
public interface MonostableCylinder extends Cylinder {
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getMonostableCylinder_Housing()
	...
	/**
	 * Sets the value of the '{@link xPPU.ComponentRepository.MonostableCylinder#getHousing <em>Housing</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getMonostableCylinder_Spring()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link xPPU.ComponentRepository.MonostableCylinder#getSpring <em>Spring</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link xPPU.ComponentRepository.ReedSwitch}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getMonostableCylinder_ReedSwitches()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link xPPU.ComponentRepository.CylinderPart}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getMonostableCylinder_CylinderPart()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link xPPU.ComponentRepository.RegularValve}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getMonostableCylinder_Valve()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#getMonostableCylinder_BusSlave()
	 * @model containment="true" required="true"
	 * @generated
	 */
