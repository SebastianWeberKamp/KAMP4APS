 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.InterfaceRepository.impl.ScrewingImpl#getIntefacePart <em>Inteface Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScrewingImpl extends InterfaceImpl implements Screwing {
	...
	protected EClass eStaticClass() {
		return InterfaceRepositoryPackage.Literals.SCREWING;
	}
		...
		if (intefacePart != null && intefacePart.eIsProxy()) {
			...
			if (intefacePart != oldIntefacePart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InterfaceRepositoryPackage.SCREWING__INTEFACE_PART, oldIntefacePart, intefacePart));
			}
		}
		return intefacePart;
	}
	...
	public void setIntefacePart(Interface newIntefacePart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InterfaceRepositoryPackage.SCREWING__INTEFACE_PART, oldIntefacePart, intefacePart));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InterfaceRepositoryPackage.SCREWING__INTEFACE_PART:
