 ...
 * </p>
 * <ul>
 *   <li>{@link fieldofactivityannotations.impl.TestCaseImpl#getTestName <em>Test Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TestCaseImpl extends MinimalEObjectImpl.Container implements TestCase {
	...
	public void setTestName(String newTestName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.TEST_CASE__TEST_NAME, oldTestName, testName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FieldofactivityannotationsPackage.TEST_CASE__TEST_NAME:
				return getTestName();
		}
