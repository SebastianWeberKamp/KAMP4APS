 ...
 * </p>
 * <ul>
 *   <li>{@link fieldofactivityannotations.impl.StructureDrawingImpl#getDrawn_structure <em>Drawn structure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureDrawingImpl extends DrawingImpl implements StructureDrawing {
	...
	protected EClass eStaticClass() {
		return FieldofactivityannotationsPackage.Literals.STRUCTURE_DRAWING;
	}
		...
		if (drawn_structure != null && drawn_structure.eIsProxy()) {
			...
			if (drawn_structure != oldDrawn_structure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FieldofactivityannotationsPackage.STRUCTURE_DRAWING__DRAWN_STRUCTURE, oldDrawn_structure, drawn_structure));
			}
		}
	...
	public void setDrawn_structure(Structure newDrawn_structure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.STRUCTURE_DRAWING__DRAWN_STRUCTURE, oldDrawn_structure, drawn_structure));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FieldofactivityannotationsPackage.STRUCTURE_DRAWING__DRAWN_STRUCTURE:
