 ...
 *   <li>{@link fieldofactivityannotations.impl.StockSpecificationImpl#getRole <em>Role</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StockSpecificationImpl extends MinimalEObjectImpl.Container implements StockSpecification {
		...
		if (role != null && role.eIsProxy()) {
			...
			if (role != oldRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FieldofactivityannotationsPackage.STOCK_SPECIFICATION__ROLE, oldRole, role));
			}
		}
		return role;
	}
	...
	public void setRole(Role newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.STOCK_SPECIFICATION__ROLE, oldRole, role));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FieldofactivityannotationsPackage.STOCK_SPECIFICATION__ROLE:
