 ...
 * </p>
 * <ul>
 *   <li>{@link fieldofactivityannotations.impl.StructureDocumentationFilesImpl#getMainteneance <em>Mainteneance</em>}</li>
 *   <li>{@link fieldofactivityannotations.impl.StructureDocumentationFilesImpl#getInstructions <em>Instructions</em>}</li>
 *   <li>{@link fieldofactivityannotations.impl.StructureDocumentationFilesImpl#getTrainingIntern <em>Training Intern</em>}</li>
 *   <li>{@link fieldofactivityannotations.impl.StructureDocumentationFilesImpl#getTrainingExternal <em>Training External</em>}</li>
 *   <li>{@link fieldofactivityannotations.impl.StructureDocumentationFilesImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fieldofactivityannotations.impl.StructureDocumentationFilesImpl#getDocumentedStructure <em>Documented Structure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureDocumentationFilesImpl extends MinimalEObjectImpl.Container implements StructureDocumentationFiles {
	...
	protected EClass eStaticClass() {
		return FieldofactivityannotationsPackage.Literals.STRUCTURE_DOCUMENTATION_FILES;
	}
	...
	public EList<MainteneanceDocumentation> getMainteneance() {
		if (mainteneance == null) {
			mainteneance = new EObjectContainmentWithInverseEList<MainteneanceDocumentation>(MainteneanceDocumentation.class, this, FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__MAINTENEANCE, FieldofactivityannotationsPackage.MAINTENEANCE_DOCUMENTATION__PARENT);
		}
		return mainteneance;
	}
	...
	public EList<OperatorInstructions> getInstructions() {
		if (instructions == null) {
			instructions = new EObjectContainmentWithInverseEList<OperatorInstructions>(OperatorInstructions.class, this, FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__INSTRUCTIONS, FieldofactivityannotationsPackage.OPERATOR_INSTRUCTIONS__PARENT);
		}
		return instructions;
	}
	...
	public EList<TrainingDocIntern> getTrainingIntern() {
		if (trainingIntern == null) {
			trainingIntern = new EObjectContainmentWithInverseEList<TrainingDocIntern>(TrainingDocIntern.class, this, FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__TRAINING_INTERN, FieldofactivityannotationsPackage.TRAINING_DOC_INTERN__PARENT);
		}
	...
	public EList<TrainingDocExternal> getTrainingExternal() {
		if (trainingExternal == null) {
			trainingExternal = new EObjectContainmentWithInverseEList<TrainingDocExternal>(TrainingDocExternal.class, this, FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__TRAINING_EXTERNAL, FieldofactivityannotationsPackage.TRAINING_DOC_EXTERNAL__PARENT);
		}
	...
	public DocumentationSpecification getParent() {
		if (eContainerFeatureID() != FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT) return null;
	...
	public NotificationChain basicSetParent(DocumentationSpecification newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(DocumentationSpecification newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, FieldofactivityannotationsPackage.DOCUMENTATION_SPECIFICATION__STRUCTURE_DOCUMENTATION, DocumentationSpecification.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT, newParent, newParent));
	}
		...
		if (documentedStructure != null && documentedStructure.eIsProxy()) {
			...
			if (documentedStructure != oldDocumentedStructure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__DOCUMENTED_STRUCTURE, oldDocumentedStructure, documentedStructure));
			}
		}
	...
	public void setDocumentedStructure(Structure newDocumentedStructure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__DOCUMENTED_STRUCTURE, oldDocumentedStructure, documentedStructure));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__MAINTENEANCE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getMainteneance()).basicAdd(otherEnd, msgs);
			case FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__INSTRUCTIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getInstructions()).basicAdd(otherEnd, msgs);
			case FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__TRAINING_INTERN:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTrainingIntern()).basicAdd(otherEnd, msgs);
			case FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__TRAINING_EXTERNAL:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTrainingExternal()).basicAdd(otherEnd, msgs);
			case FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT:
				return eInternalContainer().eInverseRemove(this, FieldofactivityannotationsPackage.DOCUMENTATION_SPECIFICATION__STRUCTURE_DOCUMENTATION, DocumentationSpecification.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT:
				return getParent();
			case FieldofactivityannotationsPackage.STRUCTURE_DOCUMENTATION_FILES__DOCUMENTED_STRUCTURE:
