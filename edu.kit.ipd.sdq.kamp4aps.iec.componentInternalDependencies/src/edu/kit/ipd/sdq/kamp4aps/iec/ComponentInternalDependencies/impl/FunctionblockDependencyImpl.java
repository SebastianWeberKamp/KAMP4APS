 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.ComponentInternalDependencies.impl.FunctionblockDependencyImpl#getProvidedFunctionBlock <em>Provided Function Block</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.ComponentInternalDependencies.impl.FunctionblockDependencyImpl#getRequiredResource <em>Required Resource</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.ComponentInternalDependencies.impl.FunctionblockDependencyImpl#getHasMethodDependency <em>Has Method Dependency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionblockDependencyImpl extends MinimalEObjectImpl.Container implements FunctionblockDependency {
	 ...
	 * @ordered
	 */
	protected IFunctionblock requiredResource;
	 ...
	 * @generated
	 */
	public IFunctionblock basicGetRequiredResource() {
		return requiredResource;
	}
	 ...
	 * @generated
	 */
	public void setRequiredResource(IFunctionblock newRequiredResource) {
		IFunctionblock oldRequiredResource = requiredResource;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ComponentInternalDependenciesPackage.FUNCTIONBLOCK_DEPENDENCY__PROVIDED_FUNCTION_BLOCK:
				...
				return;
			case ComponentInternalDependenciesPackage.FUNCTIONBLOCK_DEPENDENCY__REQUIRED_RESOURCE:
				setRequiredResource((IFunctionblock)newValue);
				return;
			case ComponentInternalDependenciesPackage.FUNCTIONBLOCK_DEPENDENCY__HAS_METHOD_DEPENDENCY:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ComponentInternalDependenciesPackage.FUNCTIONBLOCK_DEPENDENCY__PROVIDED_FUNCTION_BLOCK:
				...
				return;
			case ComponentInternalDependenciesPackage.FUNCTIONBLOCK_DEPENDENCY__REQUIRED_RESOURCE:
				setRequiredResource((IFunctionblock)null);
				return;
			case ComponentInternalDependenciesPackage.FUNCTIONBLOCK_DEPENDENCY__HAS_METHOD_DEPENDENCY:
				getHasMethodDependency().clear();
				return;
