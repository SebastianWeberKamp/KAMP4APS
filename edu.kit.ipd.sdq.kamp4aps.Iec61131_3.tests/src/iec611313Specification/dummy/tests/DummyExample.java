...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>dummy</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DummyExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.dummy"));
				CodeBodyDummy root = DummyFactory.eINSTANCE.createCodeBodyDummy();
