...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>function_blocks</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class Function_blocksExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(Function_blocksPackage.eNS_URI, 
			 Function_blocksPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.function_blocks"));
				FunctionBlockInvocation root = Function_blocksFactory.eINSTANCE.createFunctionBlockInvocation();
