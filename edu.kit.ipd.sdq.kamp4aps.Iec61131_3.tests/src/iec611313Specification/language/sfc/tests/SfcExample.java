...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>sfc</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SfcExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.sfc"));
				Action root = SfcFactory.eINSTANCE.createAction();
