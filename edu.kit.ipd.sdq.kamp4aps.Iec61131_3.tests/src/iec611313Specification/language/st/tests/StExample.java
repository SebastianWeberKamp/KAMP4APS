...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>st</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class StExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.st"));
				Case root = StFactory.eINSTANCE.createCase();
