...
public class IECRepositoryPackageImpl extends EPackageImpl implements IECRepositoryPackage {
	 ...
	 * @see IECRepository.IECRepositoryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static IECRepositoryPackage init() {
		...
		edu.kit.ipd.sdq.kamp4iec.model.IECRepository.impl.IECRepositoryPackageImpl theIECRepositoryPackage_1 = (edu.kit.ipd.sdq.kamp4iec.model.IECRepository.impl.IECRepositoryPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(edu.kit.ipd.sdq.kamp4iec.model.IECRepository.IECRepositoryPackage.eNS_URI) instanceof edu.kit.ipd.sdq.kamp4iec.model.IECRepository.impl.IECRepositoryPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(edu.kit.ipd.sdq.kamp4iec.model.IECRepository.IECRepositoryPackage.eNS_URI) : edu.kit.ipd.sdq.kamp4iec.model.IECRepository.IECRepositoryPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		edu.kit.ipd.sdq.kamp4iec.model.IECRepository.IECRepositoryPackage theIECRepositoryPackage_1 = (edu.kit.ipd.sdq.kamp4iec.model.IECRepository.IECRepositoryPackage)EPackage.Registry.INSTANCE.getEPackage(edu.kit.ipd.sdq.kamp4iec.model.IECRepository.IECRepositoryPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theIECRepositoryPackage_1);
		...
		initEClass(enumEClass, IECRepository.Enum.class, "Enum", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEnum_Id(), ecorePackage.getEString(), "Id", null, 0, 1, IECRepository.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEnum_Name(), ecorePackage.getEString(), "Name", null, 0, 1, IECRepository.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
