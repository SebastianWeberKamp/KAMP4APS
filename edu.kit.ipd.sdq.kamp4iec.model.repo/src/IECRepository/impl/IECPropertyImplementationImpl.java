 ...
 * </p>
 * <ul>
 *   <li>{@link IECRepository.impl.IECPropertyImplementationImpl#getId <em>Id</em>}</li>
 *   <li>{@link IECRepository.impl.IECPropertyImplementationImpl#getName <em>Name</em>}</li>
 *   <li>{@link IECRepository.impl.IECPropertyImplementationImpl#getImplements <em>Implements</em>}</li>
 *   <li>{@link IECRepository.impl.IECPropertyImplementationImpl#getAccessesVariable <em>Accesses Variable</em>}</li>
 *   <li>{@link IECRepository.impl.IECPropertyImplementationImpl#getUsesEnum <em>Uses Enum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IECPropertyImplementationImpl extends MinimalEObjectImpl.Container implements IECPropertyImplementation {
	...
	public EList<IECRepository.Enum> getUsesEnum() {
		if (usesEnum == null) {
			usesEnum = new EObjectResolvingEList<IECRepository.Enum>(IECRepository.Enum.class, this, IECRepositoryPackage.IEC_PROPERTY_IMPLEMENTATION__USES_ENUM);
		}
		return usesEnum;
	}
