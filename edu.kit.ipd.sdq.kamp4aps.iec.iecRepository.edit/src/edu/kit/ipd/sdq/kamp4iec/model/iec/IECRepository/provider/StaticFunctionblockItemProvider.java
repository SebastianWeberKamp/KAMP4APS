...
import edu.kit.ipd.sdq.kamp4iec.model.iec.IECRepository.StaticFunctionblock;
...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.iec.IECRepository.StaticFunctionblock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IECRepositoryPackage.Literals.STATIC_FUNCTIONBLOCK__TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IECRepositoryPackage.Literals.STATIC_FUNCTIONBLOCK__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IECRepositoryPackage.Literals.STATIC_FUNCTIONBLOCK__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUsesEnumPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StaticFunctionblock_UsesEnum_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StaticFunctionblock_UsesEnum_feature", "_UI_StaticFunctionblock_type"),
				 IECRepositoryPackage.Literals.STATIC_FUNCTIONBLOCK__USES_ENUM,
				 true,
				 false,
				 true,
				 null,
