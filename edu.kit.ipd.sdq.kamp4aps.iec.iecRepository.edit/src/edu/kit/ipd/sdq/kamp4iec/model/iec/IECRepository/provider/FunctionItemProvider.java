...
import edu.kit.ipd.sdq.kamp4iec.model.iec.IECRepository.Function;
...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4iec.model.iec.IECRepository.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Function_Id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Function_Id_feature", "_UI_Function_type"),
				 IECRepositoryPackage.Literals.FUNCTION__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IECRepositoryPackage.Literals.FUNCTION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
