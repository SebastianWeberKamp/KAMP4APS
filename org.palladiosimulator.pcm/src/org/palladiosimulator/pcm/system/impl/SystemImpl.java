 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.system.impl.SystemImpl#getAssemblyContexts__ComposedStructure <em>Assembly Contexts Composed Structure</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.system.impl.SystemImpl#getResourceRequiredDelegationConnectors_ComposedStructure <em>Resource Required Delegation Connectors Composed Structure</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.system.impl.SystemImpl#getEventChannel__ComposedStructure <em>Event Channel Composed Structure</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.system.impl.SystemImpl#getConnectors__ComposedStructure <em>Connectors Composed Structure</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.system.impl.SystemImpl#getProvidedRoles_InterfaceProvidingEntity <em>Provided Roles Interface Providing Entity</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.system.impl.SystemImpl#getResourceRequiredRoles__ResourceInterfaceRequiringEntity <em>Resource Required Roles Resource Interface Requiring Entity</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.system.impl.SystemImpl#getRequiredRoles_InterfaceRequiringEntity <em>Required Roles Interface Requiring Entity</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.system.impl.SystemImpl#getQosAnnotations_System <em>Qos Annotations System</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemImpl extends EntityImpl implements org.palladiosimulator.pcm.system.System {
	...
	public EList<AssemblyContext> getAssemblyContexts__ComposedStructure() {
		return (EList<AssemblyContext>) eDynamicGet(SystemPackage.SYSTEM__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE,
	...
	public EList<EventChannel> getEventChannel__ComposedStructure() {
		return (EList<EventChannel>) eDynamicGet(SystemPackage.SYSTEM__EVENT_CHANNEL_COMPOSED_STRUCTURE,
	...
	public EList<Connector> getConnectors__ComposedStructure() {
		return (EList<Connector>) eDynamicGet(SystemPackage.SYSTEM__CONNECTORS_COMPOSED_STRUCTURE,
	...
	public EList<ProvidedRole> getProvidedRoles_InterfaceProvidingEntity() {
		return (EList<ProvidedRole>) eDynamicGet(SystemPackage.SYSTEM__PROVIDED_ROLES_INTERFACE_PROVIDING_ENTITY,
	...
	public EList<RequiredRole> getRequiredRoles_InterfaceRequiringEntity() {
		return (EList<RequiredRole>) eDynamicGet(SystemPackage.SYSTEM__REQUIRED_ROLES_INTERFACE_REQUIRING_ENTITY,
	...
	public EList<QoSAnnotations> getQosAnnotations_System() {
		return (EList<QoSAnnotations>) eDynamicGet(SystemPackage.SYSTEM__QOS_ANNOTATIONS_SYSTEM,
