 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.seff.seff_reliability.RecoveryAction#getPrimaryBehaviour__RecoveryAction <em>Primary Behaviour Recovery Action</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.seff.seff_reliability.RecoveryAction#getRecoveryActionBehaviours__RecoveryAction <em>Recovery Action Behaviours Recovery Action</em>}</li>
 * </ul>
 *
...
public interface RecoveryAction extends AbstractInternalControlFlowAction {
	...
	/**
	 * Sets the value of the '{@link org.palladiosimulator.pcm.seff.seff_reliability.RecoveryAction#getPrimaryBehaviour__RecoveryAction <em>Primary Behaviour Recovery Action</em>}' reference.
	 * <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 ...
	 * The list contents are of type {@link org.palladiosimulator.pcm.seff.seff_reliability.RecoveryActionBehaviour}.
	 * It is bidirectional and its opposite is '{@link org.palladiosimulator.pcm.seff.seff_reliability.RecoveryActionBehaviour#getRecoveryAction__RecoveryActionBehaviour <em>Recovery Action Recovery Action Behaviour</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
