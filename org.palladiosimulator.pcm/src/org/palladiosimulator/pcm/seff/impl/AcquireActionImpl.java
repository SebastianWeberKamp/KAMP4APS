 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.AcquireActionImpl#getPassiveresource_AcquireAction <em>Passiveresource Acquire Action</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.AcquireActionImpl#isTimeout <em>Timeout</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.AcquireActionImpl#getTimeoutValue <em>Timeout Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AcquireActionImpl extends AbstractInternalControlFlowActionImpl implements AcquireAction {
	...
	public PassiveResource getPassiveresource_AcquireAction() {
		return (PassiveResource) eDynamicGet(SeffPackage.ACQUIRE_ACTION__PASSIVERESOURCE_ACQUIRE_ACTION,
	...
	public void setPassiveresource_AcquireAction(PassiveResource newPassiveresource_AcquireAction) {
		eDynamicSet(SeffPackage.ACQUIRE_ACTION__PASSIVERESOURCE_ACQUIRE_ACTION,
	...
	public boolean isTimeout() {
		return (Boolean) eDynamicGet(SeffPackage.ACQUIRE_ACTION__TIMEOUT, SeffPackage.Literals.ACQUIRE_ACTION__TIMEOUT,
				true, true);
	}
	...
	public void setTimeout(boolean newTimeout) {
		eDynamicSet(SeffPackage.ACQUIRE_ACTION__TIMEOUT, SeffPackage.Literals.ACQUIRE_ACTION__TIMEOUT, newTimeout);
	}
	...
	public double getTimeoutValue() {
		return (Double) eDynamicGet(SeffPackage.ACQUIRE_ACTION__TIMEOUT_VALUE,
	...
	public void setTimeoutValue(double newTimeoutValue) {
		eDynamicSet(SeffPackage.ACQUIRE_ACTION__TIMEOUT_VALUE, SeffPackage.Literals.ACQUIRE_ACTION__TIMEOUT_VALUE,
				newTimeoutValue);
	}
	 ...
	 */
	@Override
	public boolean TimeoutValueOfAcquireActionMustNotBeNegative(DiagnosticChain diagnostics,
	...
	public boolean eIsSet(int featureID) {
		...
		case SeffPackage.ACQUIRE_ACTION__TIMEOUT:
			return isTimeout() != TIMEOUT_EDEFAULT;
		case SeffPackage.ACQUIRE_ACTION__TIMEOUT_VALUE:
