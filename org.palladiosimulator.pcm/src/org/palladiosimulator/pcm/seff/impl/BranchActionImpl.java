 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.BranchActionImpl#getBranches_Branch <em>Branches Branch</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BranchActionImpl extends AbstractInternalControlFlowActionImpl implements BranchAction {
	...
	public EList<AbstractBranchTransition> getBranches_Branch() {
		return (EList<AbstractBranchTransition>) eDynamicGet(SeffPackage.BRANCH_ACTION__BRANCHES_BRANCH,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case SeffPackage.BRANCH_ACTION__BRANCHES_BRANCH:
			return !getBranches_Branch().isEmpty();
		}
