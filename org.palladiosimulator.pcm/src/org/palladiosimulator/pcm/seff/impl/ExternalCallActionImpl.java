 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.ExternalCallActionImpl#getInputVariableUsages__CallAction <em>Input Variable Usages Call Action</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.ExternalCallActionImpl#getReturnVariableUsage__CallReturnAction <em>Return Variable Usage Call Return Action</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.ExternalCallActionImpl#getFailureTypes_FailureHandlingEntity <em>Failure Types Failure Handling Entity</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.ExternalCallActionImpl#getCalledService_ExternalService <em>Called Service External Service</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.ExternalCallActionImpl#getRole_ExternalService <em>Role External Service</em>}</li>
 *   <li>{@link org.palladiosimulator.pcm.seff.impl.ExternalCallActionImpl#getRetryCount <em>Retry Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalCallActionImpl extends AbstractActionImpl implements ExternalCallAction {
	...
	public EList<VariableUsage> getInputVariableUsages__CallAction() {
		return (EList<VariableUsage>) eDynamicGet(SeffPackage.EXTERNAL_CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION,
	...
	public EList<FailureType> getFailureTypes_FailureHandlingEntity() {
		return (EList<FailureType>) eDynamicGet(SeffPackage.EXTERNAL_CALL_ACTION__FAILURE_TYPES_FAILURE_HANDLING_ENTITY,
	...
	public OperationSignature getCalledService_ExternalService() {
		return (OperationSignature) eDynamicGet(SeffPackage.EXTERNAL_CALL_ACTION__CALLED_SERVICE_EXTERNAL_SERVICE,
	...
	public void setCalledService_ExternalService(OperationSignature newCalledService_ExternalService) {
		eDynamicSet(SeffPackage.EXTERNAL_CALL_ACTION__CALLED_SERVICE_EXTERNAL_SERVICE,
	...
	public OperationRequiredRole getRole_ExternalService() {
		return (OperationRequiredRole) eDynamicGet(SeffPackage.EXTERNAL_CALL_ACTION__ROLE_EXTERNAL_SERVICE,
	...
	public void setRole_ExternalService(OperationRequiredRole newRole_ExternalService) {
		eDynamicSet(SeffPackage.EXTERNAL_CALL_ACTION__ROLE_EXTERNAL_SERVICE,
	...
	public int getRetryCount() {
		return (Integer) eDynamicGet(SeffPackage.EXTERNAL_CALL_ACTION__RETRY_COUNT,
	...
	public void setRetryCount(int newRetryCount) {
		eDynamicSet(SeffPackage.EXTERNAL_CALL_ACTION__RETRY_COUNT,
	...
	public boolean eIsSet(int featureID) {
		...
		case SeffPackage.EXTERNAL_CALL_ACTION__RETRY_COUNT:
			return getRetryCount() != RETRY_COUNT_EDEFAULT;
		}
