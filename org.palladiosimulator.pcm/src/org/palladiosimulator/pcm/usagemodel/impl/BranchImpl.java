 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.usagemodel.impl.BranchImpl#getBranchTransitions_Branch <em>Branch Transitions Branch</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BranchImpl extends AbstractUserActionImpl implements Branch {
	...
	public EList<BranchTransition> getBranchTransitions_Branch() {
		return (EList<BranchTransition>) eDynamicGet(UsagemodelPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case UsagemodelPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH:
			return !getBranchTransitions_Branch().isEmpty();
		}
