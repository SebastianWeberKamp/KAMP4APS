...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>oop</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class OopExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.oop"));
				Inheritance root = OopFactory.eINSTANCE.createInheritance();
