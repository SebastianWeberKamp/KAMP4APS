...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>il</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class IlExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.il"));
				ComplexInstruction root = IlFactory.eINSTANCE.createComplexInstruction();
