...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ld</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class LdExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ld"));
				Coil root = LdFactory.eINSTANCE.createCoil();
