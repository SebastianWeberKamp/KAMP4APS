...
/**
 * This is the item provider adapter for a {@link xPPU.ControlCabinet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlCabinetItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addParentStructurePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Parent Structure feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addParentStructurePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ControlCabinet_parentStructure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ControlCabinet_parentStructure_feature", "_UI_ControlCabinet_type"),
				 XPPUPackage.Literals.CONTROL_CABINET__PARENT_STRUCTURE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XPPUPackage.Literals.CONTROL_CABINET__CONTROLLER,
				 true,
				 false,
				 true,
				 null,
