...
/**
 * This is the item provider adapter for a {@link xPPU.Rack} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XPPUPackage.Literals.RACK__SCREWING_TO_BASE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addComponentRepositoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rack_componentRepository_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rack_componentRepository_feature", "_UI_Rack_type"),
				 XPPUPackage.Literals.RACK__COMPONENT_REPOSITORY,
				 true,
				 false,
				 true,
				 null,
