...
/**
 * This is the item provider adapter for a {@link xPPU.Tank} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TankItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XPPUPackage.Literals.TANK__WATERSUPPLY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XPPUPackage.Literals.TANK__SCREWING,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addComponentRepositoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Tank_componentRepository_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Tank_componentRepository_feature", "_UI_Tank_type"),
				 XPPUPackage.Literals.TANK__COMPONENT_REPOSITORY,
				 true,
				 false,
				 true,
				 null,
