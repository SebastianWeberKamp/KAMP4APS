 ...
 * @generated
 */
public class Function_blocksSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Function_blocksPackage.FUNCTION_BLOCK_BODY_SPECIFICATION: {
				FunctionBlockBodySpecification functionBlockBodySpecification = (FunctionBlockBodySpecification)theEObject;
				T result = caseFunctionBlockBodySpecification(functionBlockBodySpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Function_blocksPackage.FUNCTION_BLOCK_INVOCATION: {
				FunctionBlockInvocation functionBlockInvocation = (FunctionBlockInvocation)theEObject;
				T result = caseFunctionBlockInvocation(functionBlockInvocation);
				if (result == null) result = caseStatement(functionBlockInvocation);
				if (result == null) result = caseInstruction(functionBlockInvocation);
				if (result == null) result = caseFBDElement(functionBlockInvocation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Function_blocksPackage.FUNCTION_BLOCK_TYPE: {
				...
				if (result == null) result = caseANY_DERIVED(functionBlockType);
				if (result == null) result = caseANY(functionBlockType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Function Block Invocation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Function Block Invocation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFunctionBlockInvocation(FunctionBlockInvocation object) {
		return null;
	}
