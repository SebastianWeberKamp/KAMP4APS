	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FunctionsPackage.FUNCTION_BODY_SPECIFICATION: {
				FunctionBodySpecification functionBodySpecification = (FunctionBodySpecification)theEObject;
				T result = caseFunctionBodySpecification(functionBodySpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FunctionsPackage.FUNCTION_CALL: {
				...
				if (result == null) result = caseFBDElement(functionCall);
				if (result == null) result = caseLDElement(functionCall);
