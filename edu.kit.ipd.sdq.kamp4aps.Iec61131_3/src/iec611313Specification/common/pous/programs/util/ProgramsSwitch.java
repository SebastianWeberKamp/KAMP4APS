...
public class ProgramsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProgramsPackage.FUNCTION_BLOCK_INSTANCE_TASK_ASSIGNMENT: {
				FunctionBlockInstanceTaskAssignment functionBlockInstanceTaskAssignment = (FunctionBlockInstanceTaskAssignment)theEObject;
				T result = caseFunctionBlockInstanceTaskAssignment(functionBlockInstanceTaskAssignment);
				if (result == null) result = caseProgramConfigElement(functionBlockInstanceTaskAssignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProgramsPackage.PROGRAM_CONFIG_ELEMENT: {
				ProgramConfigElement programConfigElement = (ProgramConfigElement)theEObject;
				T result = caseProgramConfigElement(programConfigElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Function Block Instance Task Assignment</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Function Block Instance Task Assignment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFunctionBlockInstanceTaskAssignment(FunctionBlockInstanceTaskAssignment object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Program Config Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Program Config Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProgramConfigElement(ProgramConfigElement object) {
		return null;
	}
