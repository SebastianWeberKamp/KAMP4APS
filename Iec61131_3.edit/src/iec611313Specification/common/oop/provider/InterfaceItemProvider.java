...
/**
 * This is the item provider adapter for a {@link iec611313Specification.common.oop.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider extends ANY_DERIVEDItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OopPackage.Literals.INTERFACE__HAS_BASE_TYPE);
			childrenFeatures.add(OopPackage.Literals.INTERFACE__HAS_PROPERTY_SIGNATURES);
			childrenFeatures.add(OopPackage.Literals.INTERFACE__HAS_METHOD_SIGNATURES);
		}
	...
	public String getText(Object object) {
		String label = ((Interface)object).getTypeName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OopPackage.Literals.INTERFACE__HAS_PROPERTY_SIGNATURES,
				 OopFactory.eINSTANCE.createPropertySignature()));

		newChildDescriptors.add
			(createChildParameter
				(OopPackage.Literals.INTERFACE__HAS_METHOD_SIGNATURES,
