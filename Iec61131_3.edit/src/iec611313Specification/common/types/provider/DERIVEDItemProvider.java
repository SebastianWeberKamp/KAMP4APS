...
/**
 * This is the item provider adapter for a {@link iec611313Specification.common.types.DERIVED} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DERIVEDItemProvider extends ANY_DERIVEDItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypesPackage.Literals.DERIVED__HAS_INITIAL_DERIVED_VALUE);
			childrenFeatures.add(TypesPackage.Literals.DERIVED__HAS_SUBRANGE_RANGE);
			childrenFeatures.add(TypesPackage.Literals.DERIVED__HAS_DERIVED_BASE_TYPE);
		}
	...
	public String getText(Object object) {
		String label = ((DERIVED)object).getTypeName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.DERIVED__HAS_INITIAL_DERIVED_VALUE,
				 CommonFactory.eINSTANCE.createLiteral()));

		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.DERIVED__HAS_SUBRANGE_RANGE,
				 CommonFactory.eINSTANCE.createRange()));

		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.DERIVED__HAS_DERIVED_BASE_TYPE,
