...
public class EntityValidator extends EObjectValidator {
	...
	public boolean validateComposedProvidingRequiringEntity(
		...
		if (!validate_NoCircularContainment(composedProvidingRequiringEntity, diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(composedProvidingRequiringEntity, diagnostics,
				context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(composedProvidingRequiringEntity, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryReferenceIsContained(composedProvidingRequiringEntity, diagnostics,
					context);
		if (result || diagnostics != null)
	...
	public boolean validateResourceInterfaceProvidingRequiringEntity(
			...
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(resourceInterfaceProvidingRequiringEntity, diagnostics,
				context);
	}
