 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.pcm.repository.impl.OperationInterfaceImpl#getSignatures__OperationInterface <em>Signatures Operation Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationInterfaceImpl extends InterfaceImpl implements OperationInterface {
	...
	public EList<OperationSignature> getSignatures__OperationInterface() {
		return (EList<OperationSignature>) eDynamicGet(
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case RepositoryPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE:
			return !getSignatures__OperationInterface().isEmpty();
		}
