...
public class SeffPerformancePackageImpl extends EPackageImpl implements SeffPerformancePackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getInfrastructureCall_NumberOfCalls__InfrastructureCall(), theCorePackage.getPCMRandomVariable(),
		...
		initEReference(getResourceCall_Action__ResourceCall(), theSeffPackage.getAbstractInternalControlFlowAction(),
				...
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getResourceCall_ResourceRequiredRole__ResourceCall(), theEntityPackage.getResourceRequiredRole(),
