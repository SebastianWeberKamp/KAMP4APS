...
import edu.kit.ipd.sdq.kamp4aps.iec.ComponentInternalDependencies.ComponentInternalDependenciesPackage;
...
import edu.kit.ipd.sdq.kamp4aps.iec.IECModel.IECModelFactory;
...
public class IECModelPackageImpl extends EPackageImpl implements IECModelPackage {
	 ...
	 * @see edu.kit.ipd.sdq.kamp4aps.iec.IECModel.IECModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getStaticFunctionblock_Type(), this.getStaticFunctionblock(), null, "Type", null, 1, 1, StaticFunctionblock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(enumEClass, edu.kit.ipd.sdq.kamp4aps.iec.IECModel.Enum.class, "Enum", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEnum_Id(), ecorePackage.getEString(), "Id", null, 0, 1, edu.kit.ipd.sdq.kamp4aps.iec.IECModel.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEnum_Name(), ecorePackage.getEString(), "Name", null, 0, 1, edu.kit.ipd.sdq.kamp4aps.iec.IECModel.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEnum_Type(), theIECRepositoryPackage.getEnum(), null, "Type", null, 1, 1, edu.kit.ipd.sdq.kamp4aps.iec.IECModel.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
