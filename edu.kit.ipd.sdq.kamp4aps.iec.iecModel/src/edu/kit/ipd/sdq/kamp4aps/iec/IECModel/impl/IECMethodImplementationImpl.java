 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECModel.impl.IECMethodImplementationImpl#getId <em>Id</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECModel.impl.IECMethodImplementationImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECModel.impl.IECMethodImplementationImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECModel.impl.IECMethodImplementationImpl#getAccessesGlobalVariable <em>Accesses Global Variable</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECModel.impl.IECMethodImplementationImpl#getAccessesProperty <em>Accesses Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IECMethodImplementationImpl extends MinimalEObjectImpl.Container implements IECMethodImplementation {
	 ...
	 * @ordered
	 */
	protected edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.IECMethodImplementation type;
	 ...
	 * @generated
	 */
	public edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.IECMethodImplementation getType() {
		if (type != null && type.eIsProxy()) {
			InternalEObject oldType = (InternalEObject)type;
			type = (edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.IECMethodImplementation)eResolveProxy(oldType);
			if (type != oldType) {
				if (eNotificationRequired())
	 ...
	 * @generated
	 */
	public edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.IECMethodImplementation basicGetType() {
		return type;
	}
	 ...
	 * @generated
	 */
	public void setType(edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.IECMethodImplementation newType) {
		edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.IECMethodImplementation oldType = type;
		type = newType;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case IECModelPackage.IEC_METHOD_IMPLEMENTATION__NAME:
				...
				return;
			case IECModelPackage.IEC_METHOD_IMPLEMENTATION__TYPE:
				setType((edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.IECMethodImplementation)newValue);
				return;
			case IECModelPackage.IEC_METHOD_IMPLEMENTATION__ACCESSES_GLOBAL_VARIABLE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case IECModelPackage.IEC_METHOD_IMPLEMENTATION__NAME:
				...
				return;
			case IECModelPackage.IEC_METHOD_IMPLEMENTATION__TYPE:
				setType((edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.IECMethodImplementation)null);
				return;
			case IECModelPackage.IEC_METHOD_IMPLEMENTATION__ACCESSES_GLOBAL_VARIABLE:
				getAccessesGlobalVariable().clear();
				return;
