/**
 */
package iec611313Specification.common.variables.util;
...
public class VariablesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VariablesPackage.LOCATION_SPECIFICATION: {
				LocationSpecification locationSpecification = (LocationSpecification)theEObject;
				T result = caseLocationSpecification(locationSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VariablesPackage.VARIABLE_ACCESS: {
				...
				if (result == null) result = caseSignalSink(variableAccess);
				if (result == null) result = caseFBDElement(variableAccess);
				if (result == null) result = caseLDElement(variableAccess);
				if (result == null) result = caseStatement(variableAccess);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VariablesPackage.VARIABLE_DECLARATION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Location Specification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Location Specification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLocationSpecification(LocationSpecification object) {
		return null;
	}
