...
public class VariablesAdapterFactory extends AdapterFactoryImpl {
	...
	protected VariablesSwitch<Adapter> modelSwitch =
		new VariablesSwitch<Adapter>() {
			@Override
			public Adapter caseLocationSpecification(LocationSpecification object) {
				return createLocationSpecificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link iec611313Specification.common.variables.LocationSpecification <em>Location Specification</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link iec611313Specification.common.variables.VariableAccess <em>Variable Access</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link iec611313Specification.common.variables.VariableDeclaration <em>Variable Declaration</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
