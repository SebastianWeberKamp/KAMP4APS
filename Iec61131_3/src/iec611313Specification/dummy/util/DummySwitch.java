...
public class DummySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DummyPackage.CODE_BODY_DUMMY: {
				CodeBodyDummy codeBodyDummy = (CodeBodyDummy)theEObject;
				T result = caseCodeBodyDummy(codeBodyDummy);
				if (result == null) result = caseFunctionBlockBodySpecification(codeBodyDummy);
				if (result == null) result = caseFunctionBodySpecification(codeBodyDummy);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Code Body Dummy</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Code Body Dummy</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCodeBodyDummy(CodeBodyDummy object) {
		return null;
	}
