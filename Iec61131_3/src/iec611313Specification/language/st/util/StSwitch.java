...
public class StSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StPackage.NIL_VALUE: {
				NilValue nilValue = (NilValue)theEObject;
				T result = caseNilValue(nilValue);
				if (result == null) result = caseStatement(nilValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StPackage.REPEAT: {
				Repeat repeat = (Repeat)theEObject;
				T result = caseRepeat(repeat);
				if (result == null) result = caseSimpleIteration(repeat);
				if (result == null) result = caseIteration(repeat);
			...
			case StPackage.SIMPLE_ITERATION: {
				SimpleIteration simpleIteration = (SimpleIteration)theEObject;
				T result = caseSimpleIteration(simpleIteration);
				if (result == null) result = caseIteration(simpleIteration);
				if (result == null) result = caseStatement(simpleIteration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case StPackage.STATEMENT_LIST: {
				...
				if (result == null) result = caseFunctionBodySpecification(statementList);
				if (result == null) result = caseFunctionBlockBodySpecification(statementList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StPackage.WHILE: {
				While while_ = (While)theEObject;
				T result = caseWhile(while_);
				if (result == null) result = caseSimpleIteration(while_);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Simple Iteration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Simple Iteration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSimpleIteration(SimpleIteration object) {
		return null;
	}
