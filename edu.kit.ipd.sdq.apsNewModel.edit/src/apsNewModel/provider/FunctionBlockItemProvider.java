...
/**
 * This is the item provider adapter for a {@link apsNewModel.FunctionBlock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionBlockItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApsNewModelPackage.Literals.FUNCTION_BLOCK__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApsNewModelPackage.Literals.FUNCTION_BLOCK__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApsNewModelPackage.Literals.FUNCTION_BLOCK__TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApsNewModelPackage.Literals.FUNCTION_BLOCK__ACCESSES_PROPERTY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ApsNewModelPackage.Literals.FUNCTION_BLOCK__HAS_METHOD);
			childrenFeatures.add(ApsNewModelPackage.Literals.FUNCTION_BLOCK__HAS_PROPERTY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ApsNewModelPackage.Literals.FUNCTION_BLOCK__HAS_METHOD,
				 ApsNewModelFactory.eINSTANCE.createIECMethodImplementation()));

		newChildDescriptors.add
			(createChildParameter
				(ApsNewModelPackage.Literals.FUNCTION_BLOCK__HAS_PROPERTY,
				 ApsNewModelFactory.eINSTANCE.createIECPropertyImplementation()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return ApsNewModelEditPlugin.INSTANCE;
	}
