...
/**
 * This is the item provider adapter for a {@link apsNewModel.IECPropertyImplementation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApsNewModelPackage.Literals.IEC_PROPERTY_IMPLEMENTATION__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApsNewModelPackage.Literals.IEC_PROPERTY_IMPLEMENTATION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ApsNewModelPackage.Literals.IEC_PROPERTY_IMPLEMENTATION__TYPE,
				 true,
				 false,
				 true,
				 null,
