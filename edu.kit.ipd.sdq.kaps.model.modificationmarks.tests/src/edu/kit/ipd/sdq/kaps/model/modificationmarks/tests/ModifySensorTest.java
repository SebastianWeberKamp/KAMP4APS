...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Modify Sensor</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class ModifySensorTest extends TestCase {
	...
	public static void main(String[] args) {
		TestRunner.run(ModifySensorTest.class);
	}

	/**
	 * Constructs a new Modify Sensor test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public ModifySensorTest(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		setFixture(modificationmarksFactory.eINSTANCE.createModifySensor());
	}
