...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Modify Micro Switch Module</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class ModifyMicroSwitchModuleTest extends TestCase {
	...
	public static void main(String[] args) {
		TestRunner.run(ModifyMicroSwitchModuleTest.class);
	}

	/**
	 * Constructs a new Modify Micro Switch Module test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public ModifyMicroSwitchModuleTest(String name) {
		super(name);
	}
