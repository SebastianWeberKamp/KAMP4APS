 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.impl.RampImpl#getScrewing_base <em>Screwing base</em>}</li>
 *   <li>{@link xPPU.impl.RampImpl#getScrewing_component <em>Screwing component</em>}</li>
 *   <li>{@link xPPU.impl.RampImpl#getPhysicalconnection <em>Physicalconnection</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RampImpl extends MechanicalAssemblyImpl implements Ramp {
	...
	protected EClass eStaticClass() {
		return XPPUPackage.Literals.RAMP;
	}
		...
		if (screwing_base != null && screwing_base.eIsProxy()) {
			...
			if (screwing_base != oldScrewing_base) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.RAMP__SCREWING_BASE, oldScrewing_base, screwing_base));
			}
		}
	...
	public void setScrewing_base(Screwing newScrewing_base) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.RAMP__SCREWING_BASE, oldScrewing_base, screwing_base));
	}
	...
	public Screwing getScrewing_component() {
		if (screwing_component != null && screwing_component.eIsProxy()) {
			...
			if (screwing_component != oldScrewing_component) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.RAMP__SCREWING_COMPONENT, oldScrewing_component, screwing_component));
			}
		}
	...
	public void setScrewing_component(Screwing newScrewing_component) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.RAMP__SCREWING_COMPONENT, oldScrewing_component, screwing_component));
	}
	...
	public PhysicalConnection getPhysicalconnection() {
		if (physicalconnection != null && physicalconnection.eIsProxy()) {
			...
			if (physicalconnection != oldPhysicalconnection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.RAMP__PHYSICALCONNECTION, oldPhysicalconnection, physicalconnection));
			}
		}
	...
	public void setPhysicalconnection(PhysicalConnection newPhysicalconnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.RAMP__PHYSICALCONNECTION, oldPhysicalconnection, physicalconnection));
	}
