 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.impl.ArmImpl#getMountedTo <em>Mounted To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArmImpl extends MechanicalAssemblyImpl implements Arm {
	...
	protected EClass eStaticClass() {
		return XPPUPackage.Literals.ARM;
	}
		...
		if (mountedTo != null && mountedTo.eIsProxy()) {
			...
			if (mountedTo != oldMountedTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.ARM__MOUNTED_TO, oldMountedTo, mountedTo));
			}
		}
		return mountedTo;
	}
	...
	public NotificationChain basicSetMountedTo(Crane newMountedTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPPUPackage.ARM__MOUNTED_TO, oldMountedTo, newMountedTo);
	...
	public void setMountedTo(Crane newMountedTo) {
		if (newMountedTo != mountedTo) {
			...
			if (mountedTo != null)
				msgs = ((InternalEObject)mountedTo).eInverseRemove(this, XPPUPackage.CRANE__ARM, Crane.class, msgs);
			if (newMountedTo != null)
				msgs = ((InternalEObject)newMountedTo).eInverseAdd(this, XPPUPackage.CRANE__ARM, Crane.class, msgs);
			msgs = basicSetMountedTo(newMountedTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.ARM__MOUNTED_TO, newMountedTo, newMountedTo));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XPPUPackage.ARM__MOUNTED_TO:
				if (mountedTo != null)
					msgs = ((InternalEObject)mountedTo).eInverseRemove(this, XPPUPackage.CRANE__ARM, Crane.class, msgs);
