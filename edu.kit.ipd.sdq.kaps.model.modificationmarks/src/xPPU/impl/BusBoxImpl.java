 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.impl.BusBoxImpl#getSignalinterfaces <em>Signalinterfaces</em>}</li>
 *   <li>{@link xPPU.impl.BusBoxImpl#getSignalinterface_master <em>Signalinterface master</em>}</li>
 *   <li>{@link xPPU.impl.BusBoxImpl#getSignalinterface_box <em>Signalinterface box</em>}</li>
 *   <li>{@link xPPU.impl.BusBoxImpl#getPowersupply <em>Powersupply</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BusBoxImpl extends EObjectImpl implements BusBox {
	/**
	...
	protected EClass eStaticClass() {
		return XPPUPackage.Literals.BUS_BOX;
	}
	...
	public EList<SignalInterface> getSignalinterfaces() {
		if (signalinterfaces == null) {
			signalinterfaces = new EObjectResolvingEList<SignalInterface>(SignalInterface.class, this, XPPUPackage.BUS_BOX__SIGNALINTERFACES);
		}
		...
		if (signalinterface_master != null && signalinterface_master.eIsProxy()) {
			...
			if (signalinterface_master != oldSignalinterface_master) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.BUS_BOX__SIGNALINTERFACE_MASTER, oldSignalinterface_master, signalinterface_master));
			}
		}
	...
	public void setSignalinterface_master(SignalInterface newSignalinterface_master) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.BUS_BOX__SIGNALINTERFACE_MASTER, oldSignalinterface_master, signalinterface_master));
	}
	...
	public SignalInterface getSignalinterface_box() {
		if (signalinterface_box != null && signalinterface_box.eIsProxy()) {
			...
			if (signalinterface_box != oldSignalinterface_box) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.BUS_BOX__SIGNALINTERFACE_BOX, oldSignalinterface_box, signalinterface_box));
			}
		}
	...
	public void setSignalinterface_box(SignalInterface newSignalinterface_box) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.BUS_BOX__SIGNALINTERFACE_BOX, oldSignalinterface_box, signalinterface_box));
	}
	...
	public PowerSupply getPowersupply() {
		if (powersupply != null && powersupply.eIsProxy()) {
			...
			if (powersupply != oldPowersupply) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.BUS_BOX__POWERSUPPLY, oldPowersupply, powersupply));
			}
		}
		return powersupply;
	}
	...
	public void setPowersupply(PowerSupply newPowersupply) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.BUS_BOX__POWERSUPPLY, oldPowersupply, powersupply));
	}
