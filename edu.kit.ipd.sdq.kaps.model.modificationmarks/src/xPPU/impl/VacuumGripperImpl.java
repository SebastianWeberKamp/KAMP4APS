 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.impl.VacuumGripperImpl#getMountedTo <em>Mounted To</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VacuumGripperImpl extends EObjectImpl implements VacuumGripper {
	/**
	...
	protected EClass eStaticClass() {
		return XPPUPackage.Literals.VACUUM_GRIPPER;
	}
		...
		if (mountedTo != null && mountedTo.eIsProxy()) {
			...
			if (mountedTo != oldMountedTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.VACUUM_GRIPPER__MOUNTED_TO, oldMountedTo, mountedTo));
			}
		}
		return mountedTo;
	}
	...
	public NotificationChain basicSetMountedTo(Crane newMountedTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPPUPackage.VACUUM_GRIPPER__MOUNTED_TO, oldMountedTo, newMountedTo);
	...
	public void setMountedTo(Crane newMountedTo) {
		if (newMountedTo != mountedTo) {
			...
			if (mountedTo != null)
				msgs = ((InternalEObject)mountedTo).eInverseRemove(this, XPPUPackage.CRANE__VACUUMGRIPPER, Crane.class, msgs);
			if (newMountedTo != null)
				msgs = ((InternalEObject)newMountedTo).eInverseAdd(this, XPPUPackage.CRANE__VACUUMGRIPPER, Crane.class, msgs);
			msgs = basicSetMountedTo(newMountedTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.VACUUM_GRIPPER__MOUNTED_TO, newMountedTo, newMountedTo));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XPPUPackage.VACUUM_GRIPPER__MOUNTED_TO:
				if (mountedTo != null)
					msgs = ((InternalEObject)mountedTo).eInverseRemove(this, XPPUPackage.CRANE__VACUUMGRIPPER, Crane.class, msgs);
