 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.impl.OperationPanelImpl#getScrewing_rack <em>Screwing rack</em>}</li>
 *   <li>{@link xPPU.impl.OperationPanelImpl#getLeds <em>Leds</em>}</li>
 *   <li>{@link xPPU.impl.OperationPanelImpl#getButtons <em>Buttons</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationPanelImpl extends PanelImpl implements OperationPanel {
	...
	protected EClass eStaticClass() {
		return XPPUPackage.Literals.OPERATION_PANEL;
	}
		...
		if (screwing_rack != null && screwing_rack.eIsProxy()) {
			...
			if (screwing_rack != oldScrewing_rack) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.OPERATION_PANEL__SCREWING_RACK, oldScrewing_rack, screwing_rack));
			}
		}
	...
	public void setScrewing_rack(Screwing newScrewing_rack) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.OPERATION_PANEL__SCREWING_RACK, oldScrewing_rack, screwing_rack));
	}
	...
	public EList<LED> getLeds() {
		if (leds == null) {
			leds = new EObjectResolvingEList<LED>(LED.class, this, XPPUPackage.OPERATION_PANEL__LEDS);
		}
		return leds;
	}
	...
	public EList<Button> getButtons() {
		if (buttons == null) {
			buttons = new EObjectResolvingEList<Button>(Button.class, this, XPPUPackage.OPERATION_PANEL__BUTTONS);
		}
		return buttons;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XPPUPackage.OPERATION_PANEL__SCREWING_RACK:
				if (resolve) return getScrewing_rack();
				return basicGetScrewing_rack();
			case XPPUPackage.OPERATION_PANEL__LEDS:
				return getLeds();
			case XPPUPackage.OPERATION_PANEL__BUTTONS:
				return getButtons();
		}
