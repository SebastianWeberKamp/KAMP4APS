 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.impl.WaterSplitterImpl#getWatersupply <em>Watersupply</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WaterSplitterImpl extends SplitterImpl implements WaterSplitter {
	...
	protected EClass eStaticClass() {
		return XPPUPackage.Literals.WATER_SPLITTER;
	}
		...
		if (watersupply != null && watersupply.eIsProxy()) {
			...
			if (watersupply != oldWatersupply) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.WATER_SPLITTER__WATERSUPPLY, oldWatersupply, watersupply));
			}
		}
		return watersupply;
	}
	...
	public void setWatersupply(WaterSupply newWatersupply) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.WATER_SPLITTER__WATERSUPPLY, oldWatersupply, watersupply));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XPPUPackage.WATER_SPLITTER__WATERSUPPLY:
