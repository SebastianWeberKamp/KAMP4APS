 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.impl.PneumaticSplitterImpl#getPneumaticsupply <em>Pneumaticsupply</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PneumaticSplitterImpl extends SplitterImpl implements PneumaticSplitter {
	/**
	...
	protected EClass eStaticClass() {
		return XPPUPackage.Literals.PNEUMATIC_SPLITTER;
	}
		...
		if (pneumaticsupply != null && pneumaticsupply.eIsProxy()) {
			...
			if (pneumaticsupply != oldPneumaticsupply) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.PNEUMATIC_SPLITTER__PNEUMATICSUPPLY, oldPneumaticsupply, pneumaticsupply));
			}
		}
	...
	public void setPneumaticsupply(PneumaticSupply newPneumaticsupply) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.PNEUMATIC_SPLITTER__PNEUMATICSUPPLY, oldPneumaticsupply, pneumaticsupply));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XPPUPackage.PNEUMATIC_SPLITTER__PNEUMATICSUPPLY:
