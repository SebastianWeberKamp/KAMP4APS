 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.impl.WaterSupplyImpl#getIntefacePart <em>Inteface Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WaterSupplyImpl extends EObjectImpl implements WaterSupply {
	/**
	...
	protected EClass eStaticClass() {
		return XPPUPackage.Literals.WATER_SUPPLY;
	}
		...
		if (intefacePart != null && intefacePart.eIsProxy()) {
			...
			if (intefacePart != oldIntefacePart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XPPUPackage.WATER_SUPPLY__INTEFACE_PART, oldIntefacePart, intefacePart));
			}
		}
		return intefacePart;
	}
	...
	public NotificationChain basicSetIntefacePart(Interface newIntefacePart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPPUPackage.WATER_SUPPLY__INTEFACE_PART, oldIntefacePart, newIntefacePart);
	...
	public void setIntefacePart(Interface newIntefacePart) {
		if (newIntefacePart != intefacePart) {
			...
			if (intefacePart != null)
				msgs = ((InternalEObject)intefacePart).eInverseRemove(this, XPPUPackage.INTERFACE__WATERSUPPLY, Interface.class, msgs);
			if (newIntefacePart != null)
				msgs = ((InternalEObject)newIntefacePart).eInverseAdd(this, XPPUPackage.INTERFACE__WATERSUPPLY, Interface.class, msgs);
			msgs = basicSetIntefacePart(newIntefacePart, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XPPUPackage.WATER_SUPPLY__INTEFACE_PART, newIntefacePart, newIntefacePart));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case XPPUPackage.WATER_SUPPLY__INTEFACE_PART:
				if (intefacePart != null)
					msgs = ((InternalEObject)intefacePart).eInverseRemove(this, XPPUPackage.INTERFACE__WATERSUPPLY, Interface.class, msgs);
