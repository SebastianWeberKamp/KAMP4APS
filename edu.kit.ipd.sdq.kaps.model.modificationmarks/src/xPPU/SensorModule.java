 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.SensorModule#getParentModuleContainer <em>Parent Module Container</em>}</li>
 * </ul>
 *
 * @see xPPU.XPPUPackage#getSensorModule()
 * @model
 * @generated
 */
public interface SensorModule extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link xPPU.Modules#getSensormodules <em>Sensormodules</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see xPPU.XPPUPackage#getSensorModule_ParentModuleContainer()
	 * @see xPPU.Modules#getSensormodules
	 * @model opposite="sensormodules" required="true" transient="false"
	 * @generated
	 */
	Modules getParentModuleContainer();

	/**
	 * Sets the value of the '{@link xPPU.SensorModule#getParentModuleContainer <em>Parent Module Container</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
