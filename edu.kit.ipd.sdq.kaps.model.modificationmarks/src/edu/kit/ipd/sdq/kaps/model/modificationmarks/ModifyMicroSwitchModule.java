 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.modificationmarks.ModifyMicroSwitchModule#isIsReplaced <em>Is Replaced</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.kaps.model.modificationmarks.modificationmarksPackage#getModifyMicroSwitchModule()
 * @model
 * @generated
 */
public interface ModifyMicroSwitchModule<T extends MicroswitchModule> extends AbstractModification<T, EObject> {
	 ...
	 * @see edu.kit.ipd.sdq.kaps.model.modificationmarks.modificationmarksPackage#getModifyMicroSwitchModule_IsReplaced()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.kaps.model.modificationmarks.ModifyMicroSwitchModule#isIsReplaced <em>Is Replaced</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
