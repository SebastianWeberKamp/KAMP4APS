 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.modificationmarks.ModifySensor#getModifySignalInterfaces <em>Modify Signal Interfaces</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.modificationmarks.ModifySensor#getModifyPhysicalConnections <em>Modify Physical Connections</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.kaps.model.modificationmarks.modificationmarksPackage#getModifySensor()
 * @model
 * @generated
 */
public interface ModifySensor<T extends xPPU.ComponentRepository.Sensor> extends AbstractModification<T, EObject> {
	 ...
	 * @see edu.kit.ipd.sdq.kaps.model.modificationmarks.modificationmarksPackage#getModifySensor_ModifySignalInterfaces()
	 ...
	 * @see edu.kit.ipd.sdq.kaps.model.modificationmarks.modificationmarksPackage#getModifySensor_ModifyPhysicalConnections()
	 * @model containment="true"
	 * @generated
	 */
