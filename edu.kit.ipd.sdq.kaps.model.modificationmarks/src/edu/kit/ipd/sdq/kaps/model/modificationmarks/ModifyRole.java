 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.modificationmarks.ModifyRole#getSignatureModifications <em>Signature Modifications</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.kaps.model.modificationmarks.modificationmarksPackage#getModifyRole()
 * @model
 * @generated
 */
public interface ModifyRole<T extends Role> extends ModifyEntity<T> {
	 ...
	 * @see edu.kit.ipd.sdq.kaps.model.modificationmarks.modificationmarksPackage#getModifyRole_SignatureModifications()
