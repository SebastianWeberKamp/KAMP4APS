 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.model.modificationmarks.ModifyInterface#getSignatureModifications <em>Signature Modifications</em>}</li>
 * </ul>
 *
...
public interface ModifyInterface extends ModifyEntity<Interface> {
	 ...
	 * @see edu.kit.ipd.sdq.kamp4aps.model.modificationmarks.modificationmarksPackage#getModifyInterface_SignatureModifications()
