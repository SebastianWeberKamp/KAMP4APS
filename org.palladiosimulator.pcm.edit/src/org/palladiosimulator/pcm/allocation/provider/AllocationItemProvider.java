...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.allocation.Allocation} object.
...
public class AllocationItemProvider extends EntityItemProvider {
	...
	protected void addTargetResourceEnvironment_AllocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Allocation_targetResourceEnvironment_Allocation_feature"),
	...
	protected void addSystem_AllocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Allocation_system_Allocation_feature"),
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(AllocationPackage.Literals.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION,
