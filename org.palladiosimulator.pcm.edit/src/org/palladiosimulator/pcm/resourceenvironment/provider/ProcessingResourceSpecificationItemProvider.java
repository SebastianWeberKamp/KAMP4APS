...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.resourceenvironment.ProcessingResourceSpecification} object.
...
public class ProcessingResourceSpecificationItemProvider extends IdentifierItemProvider {
	...
	protected void addSchedulingPolicyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ProcessingResourceSpecification_schedulingPolicy_feature"),
						getString("_UI_PropertyDescriptor_description",
	...
	protected void addNumberOfReplicasPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ProcessingResourceSpecification_numberOfReplicas_feature"),
						getString("_UI_PropertyDescriptor_description",
