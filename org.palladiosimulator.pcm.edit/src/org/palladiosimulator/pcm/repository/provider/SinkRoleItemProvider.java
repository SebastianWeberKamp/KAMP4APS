...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.repository.SinkRole} object.
...
public class SinkRoleItemProvider extends ProvidedRoleItemProvider {
	...
	protected void addEventGroup__SinkRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SinkRole_eventGroup__SinkRole_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SinkRole_eventGroup__SinkRole_feature",
								"_UI_SinkRole_type"),
						RepositoryPackage.Literals.SINK_ROLE__EVENT_GROUP_SINK_ROLE, true, false, true, null, null,
						null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_SinkRole_type")
