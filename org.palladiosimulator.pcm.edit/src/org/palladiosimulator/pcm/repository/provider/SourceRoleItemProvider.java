...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.repository.SourceRole} object.
	...
	protected void addEventGroup__SourceRolePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SourceRole_eventGroup__SourceRole_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SourceRole_eventGroup__SourceRole_feature",
								"_UI_SourceRole_type"),
						RepositoryPackage.Literals.SOURCE_ROLE__EVENT_GROUP_SOURCE_ROLE, true, false, true, null, null,
						null));
	}
