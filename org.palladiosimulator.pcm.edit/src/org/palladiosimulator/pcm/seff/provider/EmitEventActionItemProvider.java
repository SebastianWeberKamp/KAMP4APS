...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.seff.EmitEventAction} object.
...
public class EmitEventActionItemProvider extends AbstractActionItemProvider {
	...
	protected void addEventType__EmitEventActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_EmitEventAction_eventType__EmitEventAction_feature"),
	...
	protected void addSourceRole__EmitEventActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_EmitEventAction_sourceRole__EmitEventAction_feature"),
						getString("_UI_PropertyDescriptor_description",
