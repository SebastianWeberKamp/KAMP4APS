...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.seff.AcquireAction} object.
...
public class AcquireActionItemProvider extends AbstractInternalControlFlowActionItemProvider {
	...
	protected void addPassiveresource_AcquireActionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AcquireAction_passiveresource_AcquireAction_feature"),
	...
	protected void addTimeoutPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AcquireAction_timeout_feature"),
	...
	protected void addTimeoutValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AcquireAction_timeoutValue_feature"),
