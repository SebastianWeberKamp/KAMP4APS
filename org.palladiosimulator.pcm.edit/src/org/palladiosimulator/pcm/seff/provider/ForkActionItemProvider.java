...
public class ForkActionItemProvider extends AbstractInternalControlFlowActionItemProvider {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(SeffPackage.Literals.FORK_ACTION__ASYNCHRONOUS_FORKED_BEHAVIOURS_FORK_ACTION,
						SeffFactory.eINSTANCE.createForkedBehaviour()));

		newChildDescriptors
				.add(createChildParameter(SeffPackage.Literals.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION,
