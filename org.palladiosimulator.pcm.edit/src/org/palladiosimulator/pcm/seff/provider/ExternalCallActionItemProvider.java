...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.seff.ExternalCallAction} object.
...
public class ExternalCallActionItemProvider extends AbstractActionItemProvider {
	...
	protected void addRole_ExternalServicePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ExternalCallAction_role_ExternalService_feature"),
						getString("_UI_PropertyDescriptor_description",
	...
	protected void addRetryCountPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ExternalCallAction_retryCount_feature"),
