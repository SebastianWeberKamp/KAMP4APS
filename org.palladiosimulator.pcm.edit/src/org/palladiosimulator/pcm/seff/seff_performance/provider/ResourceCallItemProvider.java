...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.seff.seff_performance.ResourceCall} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class ResourceCallItemProvider extends CallActionItemProvider {
	...
	protected void addResourceRequiredRole__ResourceCallPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ResourceCall_resourceRequiredRole__ResourceCall_feature"),
	...
	protected void addSignature__ResourceCallPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ResourceCall_signature__ResourceCall_feature"),
						getString("_UI_PropertyDescriptor_description",
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ResourceCall_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(SeffPerformancePackage.Literals.RESOURCE_CALL__NUMBER_OF_CALLS_RESOURCE_CALL,
