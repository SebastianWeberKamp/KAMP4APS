...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.subsystem.SubSystem} object.
...
public class SubSystemItemProvider extends ComposedProvidingRequiringEntityItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_SubSystem_type")
