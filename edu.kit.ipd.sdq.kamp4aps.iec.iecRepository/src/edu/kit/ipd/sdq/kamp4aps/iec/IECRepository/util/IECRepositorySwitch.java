...
public class IECRepositorySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case IECRepositoryPackage.ENUM: {
				edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum enum_ = (edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum)theEObject;
	 ...
	 * @generated
	 */
	public T caseEnum(edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum object) {
		return null;
	}
