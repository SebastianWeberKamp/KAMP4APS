 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.RepositoryImpl#getContainsProgram <em>Contains Program</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.RepositoryImpl#getContainsInterface <em>Contains Interface</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.RepositoryImpl#getContainsFunctionBlock <em>Contains Function Block</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.RepositoryImpl#getContainsFunction <em>Contains Function</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.RepositoryImpl#getContainsVariable <em>Contains Variable</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.RepositoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.RepositoryImpl#getId <em>Id</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.RepositoryImpl#getContainsStaticFunctionblock <em>Contains Static Functionblock</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.RepositoryImpl#getContainsEnum <em>Contains Enum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RepositoryImpl extends MinimalEObjectImpl.Container implements Repository {
	 ...
	 * @ordered
	 */
	protected EList<edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum> containsEnum;
	 ...
	 * @generated
	 */
	public EList<edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum> getContainsEnum() {
		if (containsEnum == null) {
			containsEnum = new EObjectContainmentEList<edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum>(edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum.class, this, IECRepositoryPackage.REPOSITORY__CONTAINS_ENUM);
		}
		return containsEnum;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case IECRepositoryPackage.REPOSITORY__CONTAINS_ENUM:
				...
				getContainsEnum().addAll((Collection<? extends edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum>)newValue);
				return;
		}
