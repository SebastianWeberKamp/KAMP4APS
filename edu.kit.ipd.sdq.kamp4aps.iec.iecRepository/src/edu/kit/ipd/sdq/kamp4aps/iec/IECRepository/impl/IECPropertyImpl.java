 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.IECPropertyImpl#getId <em>Id</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.IECPropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.IECPropertyImpl#getUsesEnum <em>Uses Enum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IECPropertyImpl extends MinimalEObjectImpl.Container implements IECProperty {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IECRepositoryPackage.IEC_PROPERTY__NAME, oldName, name));
	}
	...
	public EList<edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum> getUsesEnum() {
		if (usesEnum == null) {
			usesEnum = new EObjectResolvingEList<edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum>(edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum.class, this, IECRepositoryPackage.IEC_PROPERTY__USES_ENUM);
		}
		return usesEnum;
	}
