 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.IECInterfaceImpl#getId <em>Id</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.IECInterfaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.IECInterfaceImpl#getDefinesIecMethod <em>Defines Iec Method</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.IECInterfaceImpl#getDefinesIecProperty <em>Defines Iec Property</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.IECInterfaceImpl#getUsesEnum <em>Uses Enum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IECInterfaceImpl extends MinimalEObjectImpl.Container implements IECInterface {
	...
	public EList<edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum> getUsesEnum() {
		if (usesEnum == null) {
			usesEnum = new EObjectResolvingEList<edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum>(edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum.class, this, IECRepositoryPackage.IEC_INTERFACE__USES_ENUM);
		}
		return usesEnum;
	}
