 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.StaticFunctionblockImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.StaticFunctionblockImpl#getId <em>Id</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.StaticFunctionblockImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.impl.StaticFunctionblockImpl#getUsesEnum <em>Uses Enum</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StaticFunctionblockImpl extends MinimalEObjectImpl.Container implements StaticFunctionblock {
	...
	public EList<edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum> getUsesEnum() {
		if (usesEnum == null) {
			usesEnum = new EObjectResolvingEList<edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum>(edu.kit.ipd.sdq.kamp4aps.iec.IECRepository.Enum.class, this, IECRepositoryPackage.STATIC_FUNCTIONBLOCK__USES_ENUM);
		}
		return usesEnum;
	}
