...
/**
 * This is the item provider adapter for a {@link iec611313Specification.common.types.ENUMERATION} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ENUMERATIONItemProvider extends ANY_DERIVEDItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypesPackage.Literals.ENUMERATION__CONTAINS_ENUM_VALUE);
			childrenFeatures.add(TypesPackage.Literals.ENUMERATION__HAS_INITIAL_ENUM_VALUE);
		}
	...
	public String getText(Object object) {
		String label = ((ENUMERATION)object).getTypeName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.ENUMERATION__CONTAINS_ENUM_VALUE,
				 CommonFactory.eINSTANCE.createLiteral()));

		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.Literals.ENUMERATION__HAS_INITIAL_ENUM_VALUE,
				 CommonFactory.eINSTANCE.createLiteral()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == TypesPackage.Literals.ENUMERATION__CONTAINS_ENUM_VALUE ||
			childFeature == TypesPackage.Literals.ENUMERATION__HAS_INITIAL_ENUM_VALUE;
