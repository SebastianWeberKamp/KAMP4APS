 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.amp.model.modificationmarks.AbstractModificationRepository#getSeedModifications <em>Seed Modifications</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.amp.model.modificationmarks.AbstractModificationRepository#getChangePropagationSteps <em>Change Propagation Steps</em>}</li>
 * </ul>
 *
 * @see edu.kit.ipd.sdq.amp.model.modificationmarks.ModificationmarksPackage#getAbstractModificationRepository()
 * @model abstract="true"
 * @generated
 */
public interface AbstractModificationRepository<S extends AbstractSeedModifications, T extends AbstractChangePropagationStep> extends EObject {
	 ...
	 * @see edu.kit.ipd.sdq.amp.model.modificationmarks.ModificationmarksPackage#getAbstractModificationRepository_SeedModifications()
	...
	/**
	 * Sets the value of the '{@link edu.kit.ipd.sdq.amp.model.modificationmarks.AbstractModificationRepository#getSeedModifications <em>Seed Modifications</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see edu.kit.ipd.sdq.amp.model.modificationmarks.ModificationmarksPackage#getAbstractModificationRepository_ChangePropagationSteps()
