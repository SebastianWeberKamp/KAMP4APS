...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4aps.model.aPS.ComponentRepository.VacuumGripper} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VacuumGripperItemProvider extends ComponentItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VacuumGripperItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VacuumGripper_mountedTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VacuumGripper_mountedTo_feature", "_UI_VacuumGripper_type"),
				 ComponentRepositoryPackage.Literals.VACUUM_GRIPPER__MOUNTED_TO,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComponentRepositoryPackage.Literals.VACUUM_GRIPPER__GRIPPER_PART);
			childrenFeatures.add(ComponentRepositoryPackage.Literals.VACUUM_GRIPPER__VALVE);
			childrenFeatures.add(ComponentRepositoryPackage.Literals.VACUUM_GRIPPER__VACUUM_SWITCH);
			childrenFeatures.add(ComponentRepositoryPackage.Literals.VACUUM_GRIPPER__BUS_SLAVE);
		}
	...
	/**
	 * This returns VacuumGripper.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VacuumGripper"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VacuumGripper.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ComponentRepositoryPackage.Literals.VACUUM_GRIPPER__VALVE,
				 ComponentRepositoryFactory.eINSTANCE.createRegularValve()));

		newChildDescriptors.add
			(createChildParameter
				(ComponentRepositoryPackage.Literals.VACUUM_GRIPPER__VACUUM_SWITCH,
				 ComponentRepositoryFactory.eINSTANCE.createVacuumSwitch()));

		newChildDescriptors.add
			(createChildParameter
				(ComponentRepositoryPackage.Literals.VACUUM_GRIPPER__BUS_SLAVE,
