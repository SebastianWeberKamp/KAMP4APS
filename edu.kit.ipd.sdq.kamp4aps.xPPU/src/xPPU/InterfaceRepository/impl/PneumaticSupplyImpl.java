 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.InterfaceRepository.impl.PneumaticSupplyImpl#getIntefacePart <em>Inteface Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PneumaticSupplyImpl extends InterfaceImpl implements PneumaticSupply {
	/**
	...
	protected EClass eStaticClass() {
		return InterfaceRepositoryPackage.Literals.PNEUMATIC_SUPPLY;
	}
		...
		if (intefacePart != null && intefacePart.eIsProxy()) {
			...
			if (intefacePart != oldIntefacePart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InterfaceRepositoryPackage.PNEUMATIC_SUPPLY__INTEFACE_PART, oldIntefacePart, intefacePart));
			}
		}
		return intefacePart;
	}
	...
	public void setIntefacePart(Interface newIntefacePart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InterfaceRepositoryPackage.PNEUMATIC_SUPPLY__INTEFACE_PART, oldIntefacePart, intefacePart));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InterfaceRepositoryPackage.PNEUMATIC_SUPPLY__INTEFACE_PART:
