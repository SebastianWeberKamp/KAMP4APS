 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.InterfaceRepository.impl.ClampingImpl#getIntefacePart <em>Inteface Part</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClampingImpl extends InterfaceImpl implements Clamping {
	/**
	...
	protected EClass eStaticClass() {
		return InterfaceRepositoryPackage.Literals.CLAMPING;
	}
		...
		if (intefacePart != null && intefacePart.eIsProxy()) {
			...
			if (intefacePart != oldIntefacePart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InterfaceRepositoryPackage.CLAMPING__INTEFACE_PART, oldIntefacePart, intefacePart));
			}
		}
		return intefacePart;
	}
	...
	public void setIntefacePart(Interface newIntefacePart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InterfaceRepositoryPackage.CLAMPING__INTEFACE_PART, oldIntefacePart, intefacePart));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InterfaceRepositoryPackage.CLAMPING__INTEFACE_PART:
