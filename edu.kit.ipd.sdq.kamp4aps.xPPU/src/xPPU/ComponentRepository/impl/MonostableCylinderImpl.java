 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.ComponentRepository.impl.MonostableCylinderImpl#getHousing <em>Housing</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.MonostableCylinderImpl#getSpring <em>Spring</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.MonostableCylinderImpl#getReedSwitches <em>Reed Switches</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.MonostableCylinderImpl#getCylinderPart <em>Cylinder Part</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.MonostableCylinderImpl#getValve <em>Valve</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.MonostableCylinderImpl#getBusSlave <em>Bus Slave</em>}</li>
 * </ul>
 *
 * @generated
 */
