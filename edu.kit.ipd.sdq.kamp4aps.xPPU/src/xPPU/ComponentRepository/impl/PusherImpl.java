 ...
 * </p>
 * <ul>
 *   <li>{@link xPPU.ComponentRepository.impl.PusherImpl#getComponentsRepository <em>Components Repository</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.PusherImpl#getFixtureCylinder <em>Fixture Cylinder</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.PusherImpl#getMonostableCylinder <em>Monostable Cylinder</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.PusherImpl#getBusBox <em>Bus Box</em>}</li>
 *   <li>{@link xPPU.ComponentRepository.impl.PusherImpl#getBusCable <em>Bus Cable</em>}</li>
 * </ul>
 *
 * @generated
 */
