...
import xPPU.ComponentRepository.MonostableCylinder;
...
import xPPU.ComponentRepository.Pipe;
...
public class ComponentRepositoryPackageImpl extends EPackageImpl implements ComponentRepositoryPackage {
	 ...
	 * @see xPPU.ComponentRepository.ComponentRepositoryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		rubberBandEClass.getESuperTypes().add(theMechanicalComponentsPackage.getMechanicalPart());
		...
		tableEClass.getESuperTypes().add(this.getMechanicalAssembly());
		gripperPartEClass.getESuperTypes().add(this.getMechanicalAssembly());
		...
		initEReference(getVacuumGripper_GripperPart(), this.getGripperPart(), null, "gripperPart", null, 1, 1, VacuumGripper.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConveyorBelt_RubberBand(), this.getRubberBand(), null, "rubberBand", null, 1, 1, ConveyorBelt.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTurningTable_Table_to_stand_on(), this.getTable(), null, "table_to_stand_on", null, 1, 1, TurningTable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
