 ...
 * </p>
 * <ul>
 *   <li>{@link DeploymentContext.impl.VariableMappingImpl#getName <em>Name</em>}</li>
 *   <li>{@link DeploymentContext.impl.VariableMappingImpl#getProgramVariable <em>Program Variable</em>}</li>
 *   <li>{@link DeploymentContext.impl.VariableMappingImpl#getInterfaceDeclaration <em>Interface Declaration</em>}</li>
 *   <li>{@link DeploymentContext.impl.VariableMappingImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableMappingImpl extends MinimalEObjectImpl.Container implements VariableMapping {
	 ...
	 * @ordered
	 */
	protected edu.kit.ipd.sdq.kamp4iec.model.IECModel.GlobalVariable programVariable;
	 ...
	 * @generated
	 */
	public edu.kit.ipd.sdq.kamp4iec.model.IECModel.GlobalVariable getProgramVariable() {
		if (programVariable != null && programVariable.eIsProxy()) {
			InternalEObject oldProgramVariable = (InternalEObject)programVariable;
			programVariable = (edu.kit.ipd.sdq.kamp4iec.model.IECModel.GlobalVariable)eResolveProxy(oldProgramVariable);
	 ...
	 * @generated
	 */
	public edu.kit.ipd.sdq.kamp4iec.model.IECModel.GlobalVariable basicGetProgramVariable() {
		return programVariable;
	}
	 ...
	 * @generated
	 */
	public void setProgramVariable(edu.kit.ipd.sdq.kamp4iec.model.IECModel.GlobalVariable newProgramVariable) {
		edu.kit.ipd.sdq.kamp4iec.model.IECModel.GlobalVariable oldProgramVariable = programVariable;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DeploymentContextPackage.VARIABLE_MAPPING__NAME:
				...
				return;
			case DeploymentContextPackage.VARIABLE_MAPPING__PROGRAM_VARIABLE:
				setProgramVariable((edu.kit.ipd.sdq.kamp4iec.model.IECModel.GlobalVariable)newValue);
				return;
			case DeploymentContextPackage.VARIABLE_MAPPING__INTERFACE_DECLARATION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case DeploymentContextPackage.VARIABLE_MAPPING__NAME:
				...
				return;
			case DeploymentContextPackage.VARIABLE_MAPPING__PROGRAM_VARIABLE:
				setProgramVariable((edu.kit.ipd.sdq.kamp4iec.model.IECModel.GlobalVariable)null);
				return;
			case DeploymentContextPackage.VARIABLE_MAPPING__INTERFACE_DECLARATION:
