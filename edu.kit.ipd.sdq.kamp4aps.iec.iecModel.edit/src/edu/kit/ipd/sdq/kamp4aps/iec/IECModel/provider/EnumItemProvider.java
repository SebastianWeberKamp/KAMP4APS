...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp4aps.iec.IECModel.Enum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 IECModelPackage.Literals.ENUM__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((edu.kit.ipd.sdq.kamp4aps.iec.IECModel.Enum)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(edu.kit.ipd.sdq.kamp4aps.iec.IECModel.Enum.class)) {
