...
import ComponentInternalDependencies.FunctionblockDependency;
...
import apsNewModel.impl.ApsNewModelPackageImpl;
...
public class ComponentInternalDependenciesPackageImpl extends EPackageImpl implements ComponentInternalDependenciesPackage {
	 ...
	 * @see ComponentInternalDependencies.ComponentInternalDependenciesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ComponentInternalDependenciesPackage init() {
		...
		ApsNewModelPackageImpl theApsNewModelPackage = (ApsNewModelPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(ApsNewModelPackage.eNS_URI) instanceof ApsNewModelPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(ApsNewModelPackage.eNS_URI) : ApsNewModelPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getFunctionblockDependency_RequiredResource(), theIECRepositoryPackage.getIFunctionblock(), null, "RequiredResource", null, 1, 1, FunctionblockDependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMethodDependency_RequiredResource(), theIECRepositoryPackage.getIResource(), null, "RequiredResource", null, 1, 1, MethodDependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
