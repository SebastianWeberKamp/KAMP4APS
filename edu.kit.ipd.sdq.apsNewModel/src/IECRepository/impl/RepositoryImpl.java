 ...
 * </p>
 * <ul>
 *   <li>{@link IECRepository.impl.RepositoryImpl#getContainsProgram <em>Contains Program</em>}</li>
 *   <li>{@link IECRepository.impl.RepositoryImpl#getContainsInterface <em>Contains Interface</em>}</li>
 *   <li>{@link IECRepository.impl.RepositoryImpl#getContainsFunctionBlock <em>Contains Function Block</em>}</li>
 *   <li>{@link IECRepository.impl.RepositoryImpl#getContainsFunction <em>Contains Function</em>}</li>
 *   <li>{@link IECRepository.impl.RepositoryImpl#getContainsVariable <em>Contains Variable</em>}</li>
 *   <li>{@link IECRepository.impl.RepositoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link IECRepository.impl.RepositoryImpl#getId <em>Id</em>}</li>
 *   <li>{@link IECRepository.impl.RepositoryImpl#getContainsStaticFunctionblock <em>Contains Static Functionblock</em>}</li>
 *   <li>{@link IECRepository.impl.RepositoryImpl#getContainsEnum <em>Contains Enum</em>}</li>
 * </ul>
 *
 * @generated
 */
