...
import ComponentInternalDependencies.impl.ComponentInternalDependenciesPackageImpl;

import IECRepository.IECRepositoryPackage;

import IECRepository.impl.IECRepositoryPackageImpl;
 ...
 * @generated
 */
public class ApsNewModelPackageImpl extends EPackageImpl implements ApsNewModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see apsNewModel.ApsNewModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ApsNewModelPackageImpl() {
		super(eNS_URI, ApsNewModelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ApsNewModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ApsNewModelPackage init() {
		if (isInited) return (ApsNewModelPackage)EPackage.Registry.INSTANCE.getEPackage(ApsNewModelPackage.eNS_URI);

		// Obtain or create and register package
		ApsNewModelPackageImpl theApsNewModelPackage = (ApsNewModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ApsNewModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ApsNewModelPackageImpl());

		isInited = true;

		// Obtain or create and register interdependencies
		IECRepositoryPackageImpl theIECRepositoryPackage = (IECRepositoryPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(IECRepositoryPackage.eNS_URI) instanceof IECRepositoryPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(IECRepositoryPackage.eNS_URI) : IECRepositoryPackage.eINSTANCE);
		ComponentInternalDependenciesPackageImpl theComponentInternalDependenciesPackage = (ComponentInternalDependenciesPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(ComponentInternalDependenciesPackage.eNS_URI) instanceof ComponentInternalDependenciesPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(ComponentInternalDependenciesPackage.eNS_URI) : ComponentInternalDependenciesPackage.eINSTANCE);

		// Create package meta-data objects
		theApsNewModelPackage.createPackageContents();
		theIECRepositoryPackage.createPackageContents();
		theComponentInternalDependenciesPackage.createPackageContents();

		// Initialize created meta-data
		theApsNewModelPackage.initializePackageContents();
		...
		theApsNewModelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ApsNewModelPackage.eNS_URI, theApsNewModelPackage);
		return theApsNewModelPackage;
	}
	...
	public EAttribute getStaticFunctionblock_Id() {
		return (EAttribute)staticFunctionblockEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getStaticFunctionblock_Type() {
		return (EReference)staticFunctionblockEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getStaticFunctionblock_AccessesGlobalVariable() {
	 ...
	 * @generated
	 */
	public EReference getStaticFunctionblock_HasMethod() {
		return (EReference)staticFunctionblockEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getStaticFunctionblock_HasProperty() {
		return (EReference)staticFunctionblockEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public ApsNewModelFactory getApsNewModelFactory() {
		return (ApsNewModelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(staticFunctionblockEClass, STATIC_FUNCTIONBLOCK__ACCESSES_GLOBAL_VARIABLE);
		createEReference(staticFunctionblockEClass, STATIC_FUNCTIONBLOCK__HAS_METHOD);
		createEReference(staticFunctionblockEClass, STATIC_FUNCTIONBLOCK__HAS_PROPERTY);

		iFunctionBlockEClass = createEClass(IFUNCTION_BLOCK);
	...
	public void initializePackageContents() {
		...
		initEReference(getStaticFunctionblock_Type(), theIECRepositoryPackage.getStaticFunctionblock(), null, "Type", null, 1, 1, StaticFunctionblock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStaticFunctionblock_AccessesGlobalVariable(), this.getGlobalVariable(), null, "AccessesGlobalVariable", null, 0, -1, StaticFunctionblock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStaticFunctionblock_HasMethod(), this.getIECMethodImplementation(), null, "HasMethod", null, 0, -1, StaticFunctionblock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStaticFunctionblock_HasProperty(), this.getIECPropertyImplementation(), null, "HasProperty", null, 0, -1, StaticFunctionblock.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(enumEClass, apsNewModel.Enum.class, "Enum", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEnum_Id(), ecorePackage.getEString(), "Id", null, 0, 1, apsNewModel.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEnum_Name(), ecorePackage.getEString(), "Name", null, 0, 1, apsNewModel.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEnum_Type(), theIECRepositoryPackage.getEnum(), null, "Type", null, 1, 1, apsNewModel.Enum.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //ApsNewModelPackageImpl
