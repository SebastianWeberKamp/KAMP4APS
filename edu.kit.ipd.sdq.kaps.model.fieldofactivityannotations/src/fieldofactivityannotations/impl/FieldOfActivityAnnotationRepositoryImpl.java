 ...
 *   <li>{@link fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getComponentSpecification <em>Component Specification</em>}</li>
 *   <li>{@link fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getStaffSpecification <em>Staff Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldOfActivityAnnotationRepositoryImpl extends MinimalEObjectImpl.Container implements FieldOfActivityAnnotationRepository {
	...
	/**
	 * The cached value of the '{@link #getDevelopmentSpecification() <em>Development Specification</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getComponentSpecification() <em>Component Specification</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected ComponentSpecification componentSpecification;
	...
	public NotificationChain basicSetCalibrationSpecification(CalibrationSpecification newCalibrationSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__CALIBRATION_SPECIFICATION, oldCalibrationSpecification, newCalibrationSpecification);
	...
	public void setCalibrationSpecification(CalibrationSpecification newCalibrationSpecification) {
		if (newCalibrationSpecification != calibrationSpecification) {
			...
			if (calibrationSpecification != null)
				msgs = ((InternalEObject)calibrationSpecification).eInverseRemove(this, FieldofactivityannotationsPackage.CALIBRATION_SPECIFICATION__PARENT, CalibrationSpecification.class, msgs);
			if (newCalibrationSpecification != null)
				msgs = ((InternalEObject)newCalibrationSpecification).eInverseAdd(this, FieldofactivityannotationsPackage.CALIBRATION_SPECIFICATION__PARENT, CalibrationSpecification.class, msgs);
			msgs = basicSetCalibrationSpecification(newCalibrationSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__CALIBRATION_SPECIFICATION, newCalibrationSpecification, newCalibrationSpecification));
	}
	 ...
	 * @generated
	 */
	public DevelopmentSpecification getDevelopmentSpecification() {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDevelopmentSpecification(DevelopmentSpecification newDevelopmentSpecification, NotificationChain msgs) {
		DevelopmentSpecification oldDevelopmentSpecification = developmentSpecification;
		developmentSpecification = newDevelopmentSpecification;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DEVELOPMENT_SPECIFICATION, oldDevelopmentSpecification, newDevelopmentSpecification);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setDevelopmentSpecification(DevelopmentSpecification newDevelopmentSpecification) {
		if (newDevelopmentSpecification != developmentSpecification) {
			NotificationChain msgs = null;
			if (developmentSpecification != null)
				msgs = ((InternalEObject)developmentSpecification).eInverseRemove(this, FieldofactivityannotationsPackage.DEVELOPMENT_SPECIFICATION__PARENT, DevelopmentSpecification.class, msgs);
			if (newDevelopmentSpecification != null)
				msgs = ((InternalEObject)newDevelopmentSpecification).eInverseAdd(this, FieldofactivityannotationsPackage.DEVELOPMENT_SPECIFICATION__PARENT, DevelopmentSpecification.class, msgs);
			msgs = basicSetDevelopmentSpecification(newDevelopmentSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DEVELOPMENT_SPECIFICATION, newDevelopmentSpecification, newDevelopmentSpecification));
	}
	...
	public NotificationChain basicSetHmiSpecification(HMISpecification newHmiSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__HMI_SPECIFICATION, oldHmiSpecification, newHmiSpecification);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setHmiSpecification(HMISpecification newHmiSpecification) {
		if (newHmiSpecification != hmiSpecification) {
			...
			if (hmiSpecification != null)
				msgs = ((InternalEObject)hmiSpecification).eInverseRemove(this, FieldofactivityannotationsPackage.HMI_SPECIFICATION__PARENT, HMISpecification.class, msgs);
			if (newHmiSpecification != null)
				msgs = ((InternalEObject)newHmiSpecification).eInverseAdd(this, FieldofactivityannotationsPackage.HMI_SPECIFICATION__PARENT, HMISpecification.class, msgs);
			msgs = basicSetHmiSpecification(newHmiSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__HMI_SPECIFICATION, newHmiSpecification, newHmiSpecification));
	}
	...
	public NotificationChain basicSetEcadSpecification(ECADSpecification newEcadSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__ECAD_SPECIFICATION, oldEcadSpecification, newEcadSpecification);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEcadSpecification(ECADSpecification newEcadSpecification) {
		if (newEcadSpecification != ecadSpecification) {
			...
			if (ecadSpecification != null)
				msgs = ((InternalEObject)ecadSpecification).eInverseRemove(this, FieldofactivityannotationsPackage.ECAD_SPECIFICATION__PARENT, ECADSpecification.class, msgs);
			if (newEcadSpecification != null)
				msgs = ((InternalEObject)newEcadSpecification).eInverseAdd(this, FieldofactivityannotationsPackage.ECAD_SPECIFICATION__PARENT, ECADSpecification.class, msgs);
			msgs = basicSetEcadSpecification(newEcadSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__ECAD_SPECIFICATION, newEcadSpecification, newEcadSpecification));
	}
	...
	public NotificationChain basicSetDocumentationSpecification(DocumentationSpecification newDocumentationSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DOCUMENTATION_SPECIFICATION, oldDocumentationSpecification, newDocumentationSpecification);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDocumentationSpecification(DocumentationSpecification newDocumentationSpecification) {
		if (newDocumentationSpecification != documentationSpecification) {
			...
			if (documentationSpecification != null)
				msgs = ((InternalEObject)documentationSpecification).eInverseRemove(this, FieldofactivityannotationsPackage.DOCUMENTATION_SPECIFICATION__PARENT, DocumentationSpecification.class, msgs);
			if (newDocumentationSpecification != null)
				msgs = ((InternalEObject)newDocumentationSpecification).eInverseAdd(this, FieldofactivityannotationsPackage.DOCUMENTATION_SPECIFICATION__PARENT, DocumentationSpecification.class, msgs);
			msgs = basicSetDocumentationSpecification(newDocumentationSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DOCUMENTATION_SPECIFICATION, newDocumentationSpecification, newDocumentationSpecification));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetComponentSpecification(ComponentSpecification newComponentSpecification, NotificationChain msgs) {
		ComponentSpecification oldComponentSpecification = componentSpecification;
		componentSpecification = newComponentSpecification;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__COMPONENT_SPECIFICATION, oldComponentSpecification, newComponentSpecification);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setComponentSpecification(ComponentSpecification newComponentSpecification) {
		if (newComponentSpecification != componentSpecification) {
			NotificationChain msgs = null;
			if (componentSpecification != null)
				msgs = ((InternalEObject)componentSpecification).eInverseRemove(this, FieldofactivityannotationsPackage.COMPONENT_SPECIFICATION__PARENT, ComponentSpecification.class, msgs);
			if (newComponentSpecification != null)
				msgs = ((InternalEObject)newComponentSpecification).eInverseAdd(this, FieldofactivityannotationsPackage.COMPONENT_SPECIFICATION__PARENT, ComponentSpecification.class, msgs);
			msgs = basicSetComponentSpecification(newComponentSpecification, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__COMPONENT_SPECIFICATION, newComponentSpecification, newComponentSpecification));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__CALIBRATION_SPECIFICATION:
				if (calibrationSpecification != null)
					msgs = ((InternalEObject)calibrationSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__CALIBRATION_SPECIFICATION, null, msgs);
			...
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__ECAD_SPECIFICATION:
				if (ecadSpecification != null)
					msgs = ((InternalEObject)ecadSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__ECAD_SPECIFICATION, null, msgs);
			...
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DOCUMENTATION_SPECIFICATION:
				if (documentationSpecification != null)
					msgs = ((InternalEObject)documentationSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DOCUMENTATION_SPECIFICATION, null, msgs);
			...
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__COMPONENT_SPECIFICATION:
				if (componentSpecification != null)
					msgs = ((InternalEObject)componentSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__COMPONENT_SPECIFICATION, null, msgs);
				return basicSetComponentSpecification((ComponentSpecification)otherEnd, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__COMPONENT_SPECIFICATION:
				return basicSetComponentSpecification(null, msgs);
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__STAFF_SPECIFICATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__COMPONENT_SPECIFICATION:
				return getComponentSpecification();
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__STAFF_SPECIFICATION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DOCUMENTATION_SPECIFICATION:
				...
				return;
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__COMPONENT_SPECIFICATION:
				setComponentSpecification((ComponentSpecification)newValue);
				return;
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__STAFF_SPECIFICATION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DOCUMENTATION_SPECIFICATION:
				...
				return;
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__COMPONENT_SPECIFICATION:
				setComponentSpecification((ComponentSpecification)null);
				return;
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__STAFF_SPECIFICATION:
