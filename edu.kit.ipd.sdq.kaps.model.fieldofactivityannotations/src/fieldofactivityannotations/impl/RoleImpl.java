...
public abstract class RoleImpl extends MinimalEObjectImpl.Container implements Role {
	...
	public RoleList getParent() {
		if (parent != null && parent.eIsProxy()) {
			...
			parent = (RoleList)eResolveProxy(oldParent);
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FieldofactivityannotationsPackage.ROLE__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	 ...
	 * @generated
	 */
	public RoleList basicGetParent() {
		return parent;
	}
	...
	public NotificationChain basicSetParent(RoleList newParent, NotificationChain msgs) {
		RoleList oldParent = parent;
		parent = newParent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.ROLE__PARENT, oldParent, newParent);
	...
	public void setParent(RoleList newParent) {
		if (newParent != parent) {
			...
			if (parent != null)
				msgs = ((InternalEObject)parent).eInverseRemove(this, FieldofactivityannotationsPackage.ROLE_LIST__ROLES, RoleList.class, msgs);
			if (newParent != null)
