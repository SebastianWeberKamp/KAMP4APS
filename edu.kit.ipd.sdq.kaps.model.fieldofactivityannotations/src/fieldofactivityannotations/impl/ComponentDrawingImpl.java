 ...
 * </p>
 * <ul>
 *   <li>{@link fieldofactivityannotations.impl.ComponentDrawingImpl#getDrawn_component <em>Drawn component</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentDrawingImpl extends DrawingImpl implements ComponentDrawing {
	...
	protected EClass eStaticClass() {
		return FieldofactivityannotationsPackage.Literals.COMPONENT_DRAWING;
	}
		...
		if (drawn_component != null && drawn_component.eIsProxy()) {
			...
			if (drawn_component != oldDrawn_component) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FieldofactivityannotationsPackage.COMPONENT_DRAWING__DRAWN_COMPONENT, oldDrawn_component, drawn_component));
			}
		}
	...
	public void setDrawn_component(Component newDrawn_component) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.COMPONENT_DRAWING__DRAWN_COMPONENT, oldDrawn_component, drawn_component));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FieldofactivityannotationsPackage.COMPONENT_DRAWING__DRAWN_COMPONENT:
