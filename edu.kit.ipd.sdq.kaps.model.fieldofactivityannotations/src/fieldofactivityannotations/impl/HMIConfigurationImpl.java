...
public class HMIConfigurationImpl extends MinimalEObjectImpl.Container implements HMIConfiguration {
	...
	public HMISpecification getParent() {
		if (eContainerFeatureID() != FieldofactivityannotationsPackage.HMI_CONFIGURATION__PARENT) return null;
	...
	public NotificationChain basicSetParent(HMISpecification newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, FieldofactivityannotationsPackage.HMI_CONFIGURATION__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(HMISpecification newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != FieldofactivityannotationsPackage.HMI_CONFIGURATION__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, FieldofactivityannotationsPackage.HMI_SPECIFICATION__HMI_CONFIG, HMISpecification.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case FieldofactivityannotationsPackage.HMI_CONFIGURATION__PARENT:
				return eInternalContainer().eInverseRemove(this, FieldofactivityannotationsPackage.HMI_SPECIFICATION__HMI_CONFIG, HMISpecification.class, msgs);
		}
