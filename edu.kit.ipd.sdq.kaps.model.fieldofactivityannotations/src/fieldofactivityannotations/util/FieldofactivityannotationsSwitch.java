...
public class FieldofactivityannotationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FieldofactivityannotationsPackage.CALIBRATION_SPECIFICATION: {
			...
			case FieldofactivityannotationsPackage.DEVELOPMENT_SPECIFICATION: {
				DevelopmentSpecification developmentSpecification = (DevelopmentSpecification)theEObject;
				T result = caseDevelopmentSpecification(developmentSpecification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FieldofactivityannotationsPackage.COMPONENT_SPECIFICATION: {
			...
			case FieldofactivityannotationsPackage.ENGINEER: {
			...
			case FieldofactivityannotationsPackage.PURCHASER: {
			...
			case FieldofactivityannotationsPackage.MECHANIC: {
			...
			case FieldofactivityannotationsPackage.DOCUMENTATION: {
			...
			case FieldofactivityannotationsPackage.DRAWING: {
			...
			case FieldofactivityannotationsPackage.OPERATOR_INSTRUCTIONS: {
			...
			case FieldofactivityannotationsPackage.TRAINING_DOC_INTERN: {
			...
			case FieldofactivityannotationsPackage.TRAINING_DOC_EXTERNAL: {
			...
			case FieldofactivityannotationsPackage.SYSTEM_TEST: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Development Specification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Development Specification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDevelopmentSpecification(DevelopmentSpecification object) {
		return null;
	}
