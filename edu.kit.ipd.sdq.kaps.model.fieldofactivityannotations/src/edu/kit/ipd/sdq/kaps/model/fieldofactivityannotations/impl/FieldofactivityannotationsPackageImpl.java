...
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.BuildConfigurator;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.BuildSpecification;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.Deployer;
...
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.Developer;
...
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.File;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.FileAggregation;
...
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.Person;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.PersonList;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.ReleaseConfiguration;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.ReleaseConfigurator;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.ReleaseSpecification;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.Role;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.RoleList;
...
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.TechnologicalCorrespondenceTypes;
...
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.TestCaseAggregation;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.TestDeveloper;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.TestSpecification;
import edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.Tester;
...
public class FieldofactivityannotationsPackageImpl extends EPackageImpl implements FieldofactivityannotationsPackage {
	 ...
	 * @see edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.FieldofactivityannotationsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getFieldOfActivityAnnotationRepository_TechnologySpecification() {
	 ...
	 * @generated
	 */
	public EReference getFieldOfActivityAnnotationRepository_DesignPatternSpecification() {
	...
	public void createPackageContents() {
		...
		createEReference(fieldOfActivityAnnotationRepositoryEClass, FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__TECHNOLOGY_SPECIFICATION);
		createEReference(fieldOfActivityAnnotationRepositoryEClass, FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DESIGN_PATTERN_SPECIFICATION);
	...
	public void initializePackageContents() {
		...
		initEReference(getFieldOfActivityAnnotationRepository_TechnologySpecification(), this.getTechnologySpecification(), this.getTechnologySpecification_Parent(), "technologySpecification", null, 0, 1, FieldOfActivityAnnotationRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFieldOfActivityAnnotationRepository_DesignPatternSpecification(), this.getDesignPatternSpecification(), this.getDesignPatternSpecification_Parent(), "designPatternSpecification", null, 0, 1, FieldOfActivityAnnotationRepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDesignPatternSpecification_Parent(), this.getFieldOfActivityAnnotationRepository(), this.getFieldOfActivityAnnotationRepository_DesignPatternSpecification(), "parent", null, 1, 1, DesignPatternSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTechnologySpecification_Parent(), this.getFieldOfActivityAnnotationRepository(), this.getFieldOfActivityAnnotationRepository_TechnologySpecification(), "parent", null, 1, 1, TechnologySpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
