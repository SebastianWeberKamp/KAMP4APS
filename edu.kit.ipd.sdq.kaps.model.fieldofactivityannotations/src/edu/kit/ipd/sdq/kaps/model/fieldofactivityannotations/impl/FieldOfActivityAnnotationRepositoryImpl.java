 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getDevelopmentArtefactSpecification <em>Development Artefact Specification</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getBuildSpecification <em>Build Specification</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getTestSpecification <em>Test Specification</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getReleaseSpecification <em>Release Specification</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getDeploymentSpecification <em>Deployment Specification</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getStaffSpecification <em>Staff Specification</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getTechnologySpecification <em>Technology Specification</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kaps.model.fieldofactivityannotations.impl.FieldOfActivityAnnotationRepositoryImpl#getDesignPatternSpecification <em>Design Pattern Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldOfActivityAnnotationRepositoryImpl extends EObjectImpl implements FieldOfActivityAnnotationRepository {
	...
	public NotificationChain basicSetTechnologySpecification(TechnologySpecification newTechnologySpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__TECHNOLOGY_SPECIFICATION, oldTechnologySpecification, newTechnologySpecification);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTechnologySpecification(TechnologySpecification newTechnologySpecification) {
		if (newTechnologySpecification != technologySpecification) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__TECHNOLOGY_SPECIFICATION, newTechnologySpecification, newTechnologySpecification));
	}
	...
	public NotificationChain basicSetDesignPatternSpecification(DesignPatternSpecification newDesignPatternSpecification, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DESIGN_PATTERN_SPECIFICATION, oldDesignPatternSpecification, newDesignPatternSpecification);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDesignPatternSpecification(DesignPatternSpecification newDesignPatternSpecification) {
		if (newDesignPatternSpecification != designPatternSpecification) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DESIGN_PATTERN_SPECIFICATION, newDesignPatternSpecification, newDesignPatternSpecification));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__TECHNOLOGY_SPECIFICATION:
				if (technologySpecification != null)
					msgs = ((InternalEObject)technologySpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__TECHNOLOGY_SPECIFICATION, null, msgs);
				return basicSetTechnologySpecification((TechnologySpecification)otherEnd, msgs);
			case FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DESIGN_PATTERN_SPECIFICATION:
				if (designPatternSpecification != null)
					msgs = ((InternalEObject)designPatternSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FieldofactivityannotationsPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY__DESIGN_PATTERN_SPECIFICATION, null, msgs);
